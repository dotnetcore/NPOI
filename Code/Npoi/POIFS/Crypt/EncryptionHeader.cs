        ...
        public EncryptionHeader(string descriptor)
        {
            try
            {
                ...
                try
                {
                    ...
                    var node = xml.Descendants(XName.Get("keyData")).ToList();
	                keyData = node[0];
                }
                catch (Exception)
                {
                ...
                keySize = Int32.Parse(keyData.Attribute("keyBits").Value);
                ...
                string cipher = keyData.Attribute("cipherAlgorithm").Value;
                ...
                string chaining = keyData.Attribute("cipherChaining").Value;
                ...
                string hasAlg = keyData.Attribute("hashAlgorithm").Value;
                int hashSize = Int32.Parse(keyData.Attribute("hashSize").Value);
                ...
                string salt = keyData.Attribute("saltValue").Value;
                int saltLength = Int32.Parse(keyData.Attribute("saltSize").Value);
