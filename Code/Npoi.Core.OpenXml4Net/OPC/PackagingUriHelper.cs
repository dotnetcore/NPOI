...
namespace Npoi.Core.OpenXml4Net.OPC
{
    ...
    public class PackagingUriHelper
    {
                ...
                Uri relationshipPartUri)
        {
            ...
            if (Uri.Compare(relationshipPartUri, PACKAGE_RELATIONSHIPS_ROOT_URI, UriComponents.AbsoluteUri, UriFormat.SafeUnescaped, StringComparison.OrdinalIgnoreCase) == 0)
