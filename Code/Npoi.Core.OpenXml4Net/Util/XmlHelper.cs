...
namespace Npoi.Core.OpenXml4Net.Util
{
    public static class XmlHelper
    {
        ...
        public static bool ReadBool(XAttribute attr, bool blankValue)
        {
            if (attr == null)
                return blankValue;
        ...
        //    xmlDoc.Load(reader);
        //}
        //public static void LoadXmlSafe(XDocument xmlDoc, string xml, Encoding encoding)
        //{
        //    MemoryStream stream = new MemoryStream(encoding.GetBytes(xml));
        //    LoadXmlSafe(xmlDoc, stream);
        //}

        public static byte[] ReadBytes(XAttribute attr)
        {
        ...
        public static sbyte ReadSByte(XAttribute attr)
        {
            if (attr == null)
                return 0;
        ...
        public static ushort ReadUShort(XAttribute attr)
        {
            if (attr == null)
                return 0;
