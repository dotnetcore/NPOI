...
namespace Npoi.Core.OpenXmlFormats.Wordprocessing
{
    ...
    {
        public static CT_Settings Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
        ...
        private XElement[] hdrShapeDefaultsField;
        ...
        private XElement[] shapeDefaultsField;
        ...
        public CT_Settings()
        {
            ...
            this.shapeDefaultsField = new XElement[0];
            ...
            //this.hdrShapeDefaultsField = new XElement[0];
        ...
        public XElement[] hdrShapeDefaults
        {
            get
            {
    ...
    public class CT_WriteProtection
    {
        ...
        public static CT_WriteProtection Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_WriteProtection ctObj = new CT_WriteProtection();
            if (node.Attribute("w:recommended") != null)
                ctObj.recommended = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:recommended").Value);
            if (node.Attribute("w:cryptProviderType") != null)
                ctObj.cryptProviderType = (ST_CryptProv)Enum.Parse(typeof(ST_CryptProv), node.Attribute("w:cryptProviderType").Value);
            if (node.Attribute("w:cryptAlgorithmClass") != null)
                ctObj.cryptAlgorithmClass = (ST_AlgClass)Enum.Parse(typeof(ST_AlgClass), node.Attribute("w:cryptAlgorithmClass").Value);
            if (node.Attribute("w:cryptAlgorithmType") != null)
                ctObj.cryptAlgorithmType = (ST_AlgType)Enum.Parse(typeof(ST_AlgType), node.Attribute("w:cryptAlgorithmType").Value);
            ctObj.cryptAlgorithmSid = XmlHelper.ReadString(node.Attribute("w:cryptAlgorithmSid"));
            ctObj.cryptSpinCount = XmlHelper.ReadString(node.Attribute("w:cryptSpinCount"));
            ctObj.cryptProvider = XmlHelper.ReadString(node.Attribute("w:cryptProvider"));
            ctObj.algIdExt = XmlHelper.ReadBytes(node.Attribute("w:algIdExt"));
            ctObj.algIdExtSource = XmlHelper.ReadString(node.Attribute("w:algIdExtSource"));
            ctObj.cryptProviderTypeExt = XmlHelper.ReadBytes(node.Attribute("w:cryptProviderTypeExt"));
            ctObj.cryptProviderTypeExtSource = XmlHelper.ReadString(node.Attribute("w:cryptProviderTypeExtSource"));
            ctObj.hash = XmlHelper.ReadBytes(node.Attribute("w:hash"));
            ctObj.salt = XmlHelper.ReadBytes(node.Attribute("w:salt"));
            return ctObj;
        }
    ...
    public class CT_View
    {
        ...
        public static CT_View Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_View ctObj = new CT_View();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_View)Enum.Parse(typeof(ST_View), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_Zoom
    {
        ...
        public static CT_Zoom Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Zoom ctObj = new CT_Zoom();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_Zoom)Enum.Parse(typeof(ST_Zoom), node.Attribute("w:val").Value);
            ctObj.percent = XmlHelper.ReadString(node.Attribute("w:percent"));
            return ctObj;
        }
    ...
    public class CT_WritingStyle
    {
        ...
        public static CT_WritingStyle Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_WritingStyle ctObj = new CT_WritingStyle();
            ctObj.lang = XmlHelper.ReadString(node.Attribute("w:lang"));
            ctObj.vendorID = XmlHelper.ReadString(node.Attribute("w:vendorID"));
            ctObj.dllVersion = XmlHelper.ReadString(node.Attribute("w:dllVersion"));
            if (node.Attribute("w:nlCheck") != null)
                ctObj.nlCheck = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:nlCheck").Value);
            if (node.Attribute("w:checkStyle") != null)
                ctObj.checkStyle = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:checkStyle").Value);
            ctObj.appName = XmlHelper.ReadString(node.Attribute("w:appName"));
            return ctObj;
        }
    ...
    public class CT_Proof
    {
        ...
        public static CT_Proof Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Proof ctObj = new CT_Proof();
            if (node.Attribute("w:spelling") != null)
                ctObj.spelling = (ST_Proof)Enum.Parse(typeof(ST_Proof), node.Attribute("w:spelling").Value);
            if (node.Attribute("w:grammar") != null)
                ctObj.grammar = (ST_Proof)Enum.Parse(typeof(ST_Proof), node.Attribute("w:grammar").Value);
            return ctObj;
        }
    ...
    public class CT_DocType
    {
        ...
        public static CT_DocType Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_DocType ctObj = new CT_DocType();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_DocType)Enum.Parse(typeof(ST_DocType), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_MailMerge
    {
        ...
        public static CT_MailMerge Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_MailMergeDocType
    {
        ...
        public static CT_MailMergeDocType Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_MailMergeDocType ctObj = new CT_MailMergeDocType();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_MailMergeDocType)Enum.Parse(typeof(ST_MailMergeDocType), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_MailMergeDataType
    {
        ...
        public static CT_MailMergeDataType Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_MailMergeDataType ctObj = new CT_MailMergeDataType();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_MailMergeDataType)Enum.Parse(typeof(ST_MailMergeDataType), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_MailMergeDest
    {
        ...
        public static CT_MailMergeDest Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_MailMergeDest ctObj = new CT_MailMergeDest();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_MailMergeDest)Enum.Parse(typeof(ST_MailMergeDest), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_Odso
    {
        ...
        public static CT_Odso Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_MailMergeSourceType
    {
        ...
        public static CT_MailMergeSourceType Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_MailMergeSourceType ctObj = new CT_MailMergeSourceType();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_MailMergeSourceType)Enum.Parse(typeof(ST_MailMergeSourceType), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_OdsoFieldMapData
    {
        ...
        public static CT_OdsoFieldMapData Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "mappedName")
                ...
                else if (childNode.Name.LocalName == "lid")
                    ctObj.lid = CT_Lang.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "dynamicAddress")
    ...
    public class CT_MailMergeOdsoFMDFieldType
    {
        ...
        public static CT_MailMergeOdsoFMDFieldType Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_MailMergeOdsoFMDFieldType ctObj = new CT_MailMergeOdsoFMDFieldType();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_MailMergeOdsoFMDFieldType)Enum.Parse(typeof(ST_MailMergeOdsoFMDFieldType), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_TrackChangesView
    {
        ...
        public static CT_TrackChangesView Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_TrackChangesView ctObj = new CT_TrackChangesView();
            if (node.Attribute("w:markup") != null)
                ctObj.markup = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:markup").Value);
            if (node.Attribute("w:comments") != null)
                ctObj.comments = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:comments").Value);
            if (node.Attribute("w:insDel") != null)
                ctObj.insDel = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:insDel").Value);
            if (node.Attribute("w:formatting") != null)
                ctObj.formatting = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:formatting").Value);
            if (node.Attribute("w:inkAnnotations") != null)
                ctObj.inkAnnotations = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:inkAnnotations").Value);
            return ctObj;
        }
    ...
    public class CT_DocProtect
    {
        ...
        public static CT_DocProtect Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_DocProtect ctObj = new CT_DocProtect();
            if (node.Attribute("w:edit") != null)
                ctObj.edit = (ST_DocProtect)Enum.Parse(typeof(ST_DocProtect), node.Attribute("w:edit").Value);
            if (node.Attribute("w:formatting") != null)
                ctObj.formatting = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:formatting").Value);
            if (node.Attribute("w:enforcement") != null)
                ctObj.enforcement = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:enforcement").Value);
            if (node.Attribute("w:cryptProviderType") != null)
                ctObj.cryptProviderType = (ST_CryptProv)Enum.Parse(typeof(ST_CryptProv), node.Attribute("w:cryptProviderType").Value);
            if (node.Attribute("w:cryptAlgorithmClass") != null)
                ctObj.cryptAlgorithmClass = (ST_AlgClass)Enum.Parse(typeof(ST_AlgClass), node.Attribute("w:cryptAlgorithmClass").Value);
            ...
            ctObj.cryptProviderTypeExt = XmlHelper.ReadBytes(node.Attribute("w:cryptProviderTypeExt"));
            ctObj.cryptProviderTypeExtSource = XmlHelper.ReadString(node.Attribute("w:cryptProviderTypeExtSource"));
            ctObj.hash = XmlHelper.ReadString(node.Attribute("w:hash"));
            ctObj.salt = XmlHelper.ReadString(node.Attribute("w:salt"));
            return ctObj;
        }
    ...
    public class CT_CharacterSpacing
    {
        ...
        public static CT_CharacterSpacing Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_CharacterSpacing ctObj = new CT_CharacterSpacing();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_CharacterSpacing)Enum.Parse(typeof(ST_CharacterSpacing), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_Kinsoku
    {
        ...
        public static CT_Kinsoku Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_SaveThroughXslt
    {
        ...
        public static CT_SaveThroughXslt Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_SaveThroughXslt ctObj = new CT_SaveThroughXslt();
            ctObj.id = XmlHelper.ReadString(node.Attribute("r:id"));
            ctObj.solutionID = XmlHelper.ReadString(node.Attribute("w:solutionID"));
            return ctObj;
        }
    ...
    public class CT_Compat
    {
        ...
        public static CT_Compat Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_DocVar
    {
        ...
        private string valField;
        public static CT_DocVar Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_DocRsids
    {
        ...
        public static CT_DocRsids Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "rsidRoot")
                    ctObj.rsidRoot = CT_LongHexNumber.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "rsid")
    ...
    public class CT_ColorSchemeMapping
    {
        ...
        public static CT_ColorSchemeMapping Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_ColorSchemeMapping ctObj = new CT_ColorSchemeMapping();
            if (node.Attribute("w:bg1") != null)
                ctObj.bg1 = (ST_ColorSchemeIndex)Enum.Parse(typeof(ST_ColorSchemeIndex), node.Attribute("w:bg1").Value);
            if (node.Attribute("w:t1") != null)
                ctObj.t1 = (ST_ColorSchemeIndex)Enum.Parse(typeof(ST_ColorSchemeIndex), node.Attribute("w:t1").Value);
            if (node.Attribute("w:bg2") != null)
                ctObj.bg2 = (ST_ColorSchemeIndex)Enum.Parse(typeof(ST_ColorSchemeIndex), node.Attribute("w:bg2").Value);
            if (node.Attribute("w:t2") != null)
                ctObj.t2 = (ST_ColorSchemeIndex)Enum.Parse(typeof(ST_ColorSchemeIndex), node.Attribute("w:t2").Value);
            if (node.Attribute("w:accent1") != null)
                ctObj.accent1 = (ST_ColorSchemeIndex)Enum.Parse(typeof(ST_ColorSchemeIndex), node.Attribute("w:accent1").Value);
            if (node.Attribute("w:accent2") != null)
                ctObj.accent2 = (ST_ColorSchemeIndex)Enum.Parse(typeof(ST_ColorSchemeIndex), node.Attribute("w:accent2").Value);
            if (node.Attribute("w:accent3") != null)
                ctObj.accent3 = (ST_ColorSchemeIndex)Enum.Parse(typeof(ST_ColorSchemeIndex), node.Attribute("w:accent3").Value);
            if (node.Attribute("w:accent4") != null)
                ctObj.accent4 = (ST_ColorSchemeIndex)Enum.Parse(typeof(ST_ColorSchemeIndex), node.Attribute("w:accent4").Value);
            if (node.Attribute("w:accent5") != null)
                ctObj.accent5 = (ST_ColorSchemeIndex)Enum.Parse(typeof(ST_ColorSchemeIndex), node.Attribute("w:accent5").Value);
            if (node.Attribute("w:accent6") != null)
                ctObj.accent6 = (ST_ColorSchemeIndex)Enum.Parse(typeof(ST_ColorSchemeIndex), node.Attribute("w:accent6").Value);
            if (node.Attribute("w:hyperlink") != null)
                ctObj.hyperlink = (ST_ColorSchemeIndex)Enum.Parse(typeof(ST_ColorSchemeIndex), node.Attribute("w:hyperlink").Value);
            if (node.Attribute("w:followedHyperlink") != null)
                ctObj.followedHyperlink = (ST_ColorSchemeIndex)Enum.Parse(typeof(ST_ColorSchemeIndex), node.Attribute("w:followedHyperlink").Value);
            return ctObj;
        }
    ...
    public class CT_Captions
    {
        ...
        public static CT_Captions Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "caption")
                    ctObj.caption.Add(CT_Caption.Parse(childNode, namespaceManager));
                else if (childNode.Name.LocalName == "autoCaptions")
    ...
    public class CT_Caption
    {
        ...
        public static CT_Caption Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Caption ctObj = new CT_Caption();
            ctObj.name = XmlHelper.ReadString(node.Attribute("w:name"));
            if (node.Attribute("w:pos") != null)
                ctObj.pos = (ST_CaptionPos)Enum.Parse(typeof(ST_CaptionPos), node.Attribute("w:pos").Value);
            if (node.Attribute("w:chapNum") != null)
                ctObj.chapNum = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:chapNum").Value);
            ctObj.heading = XmlHelper.ReadString(node.Attribute("w:heading"));
            if (node.Attribute("w:noLabel") != null)
                ctObj.noLabel = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:noLabel").Value);
            if (node.Attribute("w:numFmt") != null)
                ctObj.numFmt = (ST_NumberFormat)Enum.Parse(typeof(ST_NumberFormat), node.Attribute("w:numFmt").Value);
            if (node.Attribute("w:sep") != null)
                ctObj.sep = (ST_ChapterSep)Enum.Parse(typeof(ST_ChapterSep), node.Attribute("w:sep").Value);
            return ctObj;
        }
    ...
    public class CT_AutoCaption
    {
        ...
        public static CT_AutoCaption Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_AutoCaption ctObj = new CT_AutoCaption();
            ctObj.name = XmlHelper.ReadString(node.Attribute("w:name"));
            ctObj.caption = XmlHelper.ReadString(node.Attribute("w:caption"));
            return ctObj;
        }
    ...
    public class CT_ReadingModeInkLockDown
    {
        ...
        public static CT_ReadingModeInkLockDown Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_ReadingModeInkLockDown ctObj = new CT_ReadingModeInkLockDown();
            if (node.Attribute("w:actualPg") != null)
                ctObj.actualPg = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:actualPg").Value);
            ctObj.w = XmlHelper.ReadULong(node.Attribute("w:w"));
            ctObj.h = XmlHelper.ReadULong(node.Attribute("w:h"));
            ctObj.fontSz = XmlHelper.ReadString(node.Attribute("w:fontSz"));
            return ctObj;
        }
    ...
    public class CT_SmartTagType
    {
        ...
        public static CT_SmartTagType Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.namespaceuri = XmlHelper.ReadString(node.Attribute("w:namespaceuri"));
            ctObj.name = XmlHelper.ReadString(node.Attribute("w:name"));
            ctObj.url = XmlHelper.ReadString(node.Attribute("w:url"));
            return ctObj;
        }
    ...
    public class CT_ShapeDefaults
    {
        ...
        {
            this.itemsField = new XElement[0];
        }
