...
namespace Npoi.Core.OpenXmlFormats.Wordprocessing
{
    ...
    public class CT_TabStop
    {
        ...
        public static CT_TabStop Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_TabJc)Enum.Parse(typeof(ST_TabJc), node.Attribute("w:val").Value);
            if (node.Attribute("w:leader") != null)
                ctObj.leader = (ST_TabTlc)Enum.Parse(typeof(ST_TabTlc), node.Attribute("w:leader").Value);
            ctObj.pos = XmlHelper.ReadString(node.Attribute("w:pos"));
            return ctObj;
        }
    ...
    public class CT_PTab
    {
        ...
        public static CT_PTab Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("w:alignment") != null)
                ctObj.alignment = (ST_PTabAlignment)Enum.Parse(typeof(ST_PTabAlignment), node.Attribute("w:alignment").Value);
            if (node.Attribute("w:relativeTo") != null)
                ctObj.relativeTo = (ST_PTabRelativeTo)Enum.Parse(typeof(ST_PTabRelativeTo), node.Attribute("w:relativeTo").Value);
            if (node.Attribute("w:leader") != null)
