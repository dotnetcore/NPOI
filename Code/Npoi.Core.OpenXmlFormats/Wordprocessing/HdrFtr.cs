...
namespace Npoi.Core.OpenXmlFormats.Wordprocessing
{
    ...
    public class CT_HdrFtr
    {
        ...
        public static CT_HdrFtr Parse(CT_HdrFtr ctObj, XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            {
                if (childNode.Name.LocalName == "customXmlInsRangeStart")
                {
    ...
    {
        public static CT_Ftr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
    ...
    {
        public static CT_Hdr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
    ...
    {
        public static new CT_HdrFtrRef Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_HdrFtrRef ctObj = new CT_HdrFtrRef();
            if (node.Attribute("w:type") != null)
                ctObj.type = (ST_HdrFtr)Enum.Parse(typeof(ST_HdrFtr), node.Attribute("w:type").Value);
    ...
    public class CT_FtnProps
    {
        ...
        public static CT_FtnProps Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "numStart")
                    ctObj.numStart = CT_DecimalNumber.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "numRestart")
    ...
    {
        public static CT_FtnPos Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_FtnPos ctObj = new CT_FtnPos();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_FtnPos)Enum.Parse(typeof(ST_FtnPos), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_Footnotes
    {
        ...
        public static CT_Footnotes Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "footnote")
    ...
    public class CT_FtnEdn
    {
        ...
        public static CT_FtnEdn Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_FtnEdn ctObj = new CT_FtnEdn();
            if (node.Attribute("w:type") != null)
                ctObj.type = (ST_FtnEdn)Enum.Parse(typeof(ST_FtnEdn), node.Attribute("w:type").Value);
            ctObj.id = XmlHelper.ReadString(node.Attribute("w:id"));

            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "customXmlDelRangeStart")
                {
                    ctObj.Items.Add(CT_TrackChange.Parse(childNode, namespaceManager));
    ...
    public class CT_Endnotes
    {
        ...
        public static CT_Endnotes Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "endnote")
    ...
    public class CT_FtnDocProps : CT_FtnProps
    {
        ...
        public static new CT_FtnDocProps Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "pos")
                    ...
                    ctObj.numRestart = CT_NumRestart.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "footnote")
    ...
    public class CT_FtnEdnSepRef
    {
        ...
        public static CT_FtnEdnSepRef Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_EdnProps
    {
        ...
        public static CT_EdnProps Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    {
        public static CT_EdnPos Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_EdnPos ctObj = new CT_EdnPos();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_EdnPos)Enum.Parse(typeof(ST_EdnPos), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    {
        public new static CT_EdnDocProps Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "pos")
                    ...
                    ctObj.numRestart = CT_NumRestart.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "endnote")
    ...
    public class CT_FtnEdnRef
    {
        ...
        public static CT_FtnEdnRef Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_FtnEdnRef ctObj = new CT_FtnEdnRef();
            if (node.Attribute("w:customMarkFollows") != null)
                ctObj.customMarkFollows = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:customMarkFollows").Value);
            ctObj.id = XmlHelper.ReadString(node.Attribute("w:id"));
            ctObj.DomNode = node;
            return ctObj;
        }
