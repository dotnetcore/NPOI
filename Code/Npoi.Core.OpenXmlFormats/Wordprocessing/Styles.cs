...
namespace Npoi.Core.OpenXmlFormats.Wordprocessing
{
    ...
    public class CT_Styles
    {
        ...
        public static CT_Styles Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            {
                if (childNode.Name.LocalName == "docDefaults")
                    ctObj.docDefaults = CT_DocDefaults.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "latentStyles")
    ...
    public class CT_DocDefaults
    {
        ...
        public static CT_DocDefaults Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "rPrDefault")
                    ctObj.rPrDefault = CT_RPrDefault.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "pPrDefault")
    ...
    public class CT_LatentStyles
    {
        ...
        public static CT_LatentStyles Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("w:defLockedState") != null)
                ctObj.defLockedState = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:defLockedState").Value);
            ctObj.defUIPriority = XmlHelper.ReadString(node.Attribute("w:defUIPriority"));
            if (node.Attribute("w:defSemiHidden") != null)
                ctObj.defSemiHidden = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:defSemiHidden").Value);
            if (node.Attribute("w:defUnhideWhenUsed") != null)
                ctObj.defUnhideWhenUsed = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:defUnhideWhenUsed").Value);
            if (node.Attribute("w:defQFormat") != null)
                ctObj.defQFormat = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:defQFormat").Value);
            ctObj.count = XmlHelper.ReadString(node.Attribute("w:count"));
            ctObj.lsdException = new List<CT_LsdException>();
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "lsdException")
    ...
    public class CT_Style
    {
        ...
        public static CT_Style Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("w:type") != null)
                ctObj.type = (ST_StyleType)Enum.Parse(typeof(ST_StyleType), node.Attribute("w:type").Value);
            ctObj.styleId = XmlHelper.ReadString(node.Attribute("w:styleId"));
            if (node.Attribute("w:default") != null)
                ctObj.@default = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:default").Value);
            if (node.Attribute("w:customStyle") != null)
                ctObj.customStyle = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:customStyle").Value);
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "tblStylePr")
    ...
    public class CT_Em
    {
        public static CT_Em Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Em ctObj = new CT_Em();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_Em)Enum.Parse(typeof(ST_Em), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    {
        public static CT_VerticalJc Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_VerticalJc ctObj = new CT_VerticalJc();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_VerticalJc)Enum.Parse(typeof(ST_VerticalJc), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_Shd
    {
        ...
        public static CT_Shd Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Shd ctObj = new CT_Shd();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_Shd)Enum.Parse(typeof(ST_Shd), node.Attribute("w:val").Value);
            ctObj.color = XmlHelper.ReadString(node.Attribute("w:color"));
            if (node.Attribute("w:themeColor") != null)
                ctObj.themeColor = (ST_ThemeColor)Enum.Parse(typeof(ST_ThemeColor), node.Attribute("w:themeColor").Value);
            ctObj.themeTint = XmlHelper.ReadBytes(node.Attribute("w:themeTint"));
            ctObj.themeShade = XmlHelper.ReadBytes(node.Attribute("w:themeShade"));
            ctObj.fill = XmlHelper.ReadString(node.Attribute("w:fill"));
            if (node.Attribute("w:themeFill") != null)
                ctObj.themeFill = (ST_ThemeColor)Enum.Parse(typeof(ST_ThemeColor), node.Attribute("w:themeFill").Value);
            ctObj.themeFillTint = XmlHelper.ReadBytes(node.Attribute("w:themeFillTint"));
            ctObj.themeFillShade = XmlHelper.ReadBytes(node.Attribute("w:themeFillShade"));
            return ctObj;
        }
    ...
    {
        public static CT_TextScale Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    {
        public static CT_Highlight Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Highlight ctObj = new CT_Highlight();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_HighlightColor)Enum.Parse(typeof(ST_HighlightColor), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_Underline
    {
        ...
        public static CT_Underline Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Underline ctObj = new CT_Underline();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_Underline)Enum.Parse(typeof(ST_Underline), node.Attribute("w:val").Value);
            ctObj.color = XmlHelper.ReadString(node.Attribute("w:color"));
            if (node.Attribute("w:themeColor") != null)
                ctObj.themeColor = (ST_ThemeColor)Enum.Parse(typeof(ST_ThemeColor), node.Attribute("w:themeColor").Value);
            ctObj.themeTint = XmlHelper.ReadBytes(node.Attribute("w:themeTint"));
    ...
    {
        public static CT_TextEffect Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_TextEffect ctObj = new CT_TextEffect();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_TextEffect)Enum.Parse(typeof(ST_TextEffect), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_Border
    {
        ...
        public static CT_Border Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_Border)Enum.Parse(typeof(ST_Border), node.Attribute("w:val").Value);
            ctObj.color = XmlHelper.ReadString(node.Attribute("w:color"));
            if (node.Attribute("w:themeColor") != null)
                ctObj.themeColor = (ST_ThemeColor)Enum.Parse(typeof(ST_ThemeColor), node.Attribute("w:themeColor").Value);
            ctObj.themeTint = XmlHelper.ReadBytes(node.Attribute("w:themeTint"));
            ctObj.themeShade = XmlHelper.ReadBytes(node.Attribute("w:themeShade"));
            ctObj.sz = XmlHelper.ReadULong(node.Attribute("w:sz"));
            ctObj.space = XmlHelper.ReadULong(node.Attribute("w:space"));
            if (node.Attribute("w:shadow") != null)
                ctObj.shadow = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:shadow").Value);
            if (node.Attribute("w:frame") != null)
                ctObj.frame = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:frame").Value);
            return ctObj;
        }
