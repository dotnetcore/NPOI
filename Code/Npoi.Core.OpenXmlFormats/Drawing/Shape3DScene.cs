...
namespace NPOI.OpenXmlFormats.Dml
{
    ...
    public class CT_Scene3D
    {
        ...
        public static CT_Scene3D Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            {
                if (childNode.Name.LocalName == "camera")
                    ctObj.camera = CT_Camera.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "lightRig")
                    ctObj.lightRig = CT_LightRig.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "backdrop")
