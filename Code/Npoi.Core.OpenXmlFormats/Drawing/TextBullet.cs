...
namespace NPOI.OpenXmlFormats.Dml
{
    ...
    {
        public static CT_TextBulletSizePercent Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    {
        public static CT_TextBulletSizePoint Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    {
        public static CT_TextAutonumberBullet Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_TextAutonumberBullet ctObj = new CT_TextAutonumberBullet();
            if (node.Attribute("type") != null)
                ctObj.type = (ST_TextAutonumberScheme)Enum.Parse(typeof(ST_TextAutonumberScheme), node.Attribute("type").Value);
            ctObj.startAt = XmlHelper.ReadInt(node.Attribute("startAt"));
            return ctObj;
        }
    ...
    {
        public static CT_TextCharBullet Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if(node==null)
                return null;
            CT_TextCharBullet ctObj = new CT_TextCharBullet();
            ctObj.@char = XmlHelper.ReadString(node.Attribute("char"));
            return ctObj;
        }
    ...
    {
        public static CT_TextBlipBullet Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
