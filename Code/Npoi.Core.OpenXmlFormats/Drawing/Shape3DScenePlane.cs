...
namespace Npoi.Core.OpenXmlFormats.Dml
{
    ...
    public class CT_Backdrop
    {
        ...
        public static CT_Backdrop Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "norm")
                    ctObj.norm = CT_Vector3D.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "up")
