...
namespace Npoi.Core.OpenXmlFormats.Dml.Chart
{
    ...
    public class CT_ChartSpace
    {
        ...
        public static CT_ChartSpace Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            {
                if (childNode.Name.LocalName == "date1904")
                ...
                else if (childNode.Name.LocalName == "roundedCorners")
                ...
                else if (childNode.Name.LocalName == "clrMapOvr")
                    ctObj.clrMapOvr = CT_ColorMapping.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "pivotSource")
    ...
    public class CT_RelId
    {
        ...
        public static CT_RelId Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_PageSetup
    {
        ...
        public static CT_PageSetup Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("orientation") != null)
                ctObj.orientation = (ST_PageSetupOrientation)Enum.Parse(typeof(ST_PageSetupOrientation), node.Attribute("orientation").Value);
            ...
            if (node.Attribute("horizontalDpi") != null)
                ctObj.horizontalDpi = XmlHelper.ReadInt(node.Attribute("horizontalDpi"));
            if (node.Attribute("verticalDpi") != null)
                ctObj.verticalDpi = XmlHelper.ReadInt(node.Attribute("verticalDpi"));
    ...
    public class CT_PageMargins
    {
        ...
        public static CT_PageMargins Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("l") != null)
                ctObj.l = XmlHelper.ReadDouble(node.Attribute("l"));
            if (node.Attribute("r") != null)
                ctObj.r = XmlHelper.ReadDouble(node.Attribute("r"));
            if (node.Attribute("t") != null)
                ctObj.t = XmlHelper.ReadDouble(node.Attribute("t"));
            if (node.Attribute("b") != null)
                ctObj.b = XmlHelper.ReadDouble(node.Attribute("b"));
            if (node.Attribute("header") != null)
                ctObj.header = XmlHelper.ReadDouble(node.Attribute("header"));
            if (node.Attribute("footer") != null)
    ...
    public class CT_HeaderFooter
    {
        ...
        public static CT_HeaderFooter Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("differentOddEven") != null)
                ctObj.differentOddEven = XmlHelper.ReadBool(node.Attribute("differentOddEven"));
            if (node.Attribute("differentFirst") != null)
    ...
    public class CT_PrintSettings
    {
        ...
        public static CT_PrintSettings Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "headerFooter")
    ...
    public class CT_ExternalData
    {
        ...
        public static CT_ExternalData Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "autoUpdate")
    ...
    public class CT_DispBlanksAs
    {
        ...
        public static CT_DispBlanksAs Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_DispBlanksAs ctObj = new CT_DispBlanksAs();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_DispBlanksAs)Enum.Parse(typeof(ST_DispBlanksAs), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_LegendEntry
    {
        ...
        public static CT_LegendEntry Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "Item")
    ...
    public class CT_UnsignedInt
    {
        ...
        public static CT_UnsignedInt Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Extension
    {
        ...
        public static CT_Extension Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_LegendPos
    {
        ...
        public static CT_LegendPos Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_LegendPos ctObj = new CT_LegendPos();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_LegendPos)Enum.Parse(typeof(ST_LegendPos), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_Legend
    {
        ...
        public static CT_Legend Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Layout
    {
        ...
        public static CT_Layout Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "manualLayout")
    ...
    public class CT_ManualLayout
    {
        ...
        private List<CT_Extension> extLstField;
        public static CT_ManualLayout Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "y")
                ...
                else if (childNode.Name.LocalName == "h")
    ...
    public class CT_LayoutTarget
    {
        ...
        public static CT_LayoutTarget Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_LayoutTarget ctObj = new CT_LayoutTarget();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_LayoutTarget)Enum.Parse(typeof(ST_LayoutTarget), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_LayoutMode
    {
        ...
        public static CT_LayoutMode Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_LayoutMode ctObj = new CT_LayoutMode();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_LayoutMode)Enum.Parse(typeof(ST_LayoutMode), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_Double
    {
        ...
        public static CT_Double Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_DTable
    {
        ...
        public static CT_DTable Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_SerAx
    {
        ...
        public static CT_SerAx Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Scaling
    {
        ...
        public static CT_Scaling Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    {
        public static CT_LogBase Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Orientation
    {
        ...
        public static CT_Orientation Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Orientation ctObj = new CT_Orientation();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_Orientation)Enum.Parse(typeof(ST_Orientation), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_AxPos
    {
        ...
        public static CT_AxPos Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_AxPos ctObj = new CT_AxPos();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_AxPos)Enum.Parse(typeof(ST_AxPos), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    {
        public static CT_ChartLines Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Title
    {
        ...
        public static CT_Title Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "tx")
    ...
    public class CT_Tx
    {
        ...
        public static CT_Tx Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "strRef")
                    ctObj.strRef = CT_StrRef.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "rich")
    ...
    public class CT_StrRef
    {
        ...
        public static CT_StrRef Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "f")
                    ctObj.f = childNode.Value;
                else if (childNode.Name.LocalName == "strCache")
    ...
    public class CT_StrData
    {
        ...
        public static CT_StrData Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "ptCount")
                    ctObj.ptCount = CT_UnsignedInt.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "pt")
    ...
    public class CT_StrVal
    {
        ...
        public static CT_StrVal Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_NumFmt
    {
        ...
        public static CT_NumFmt Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.sourceLinked = XmlHelper.ReadBool(node.Attribute("sourceLinked"));
            return ctObj;
        }
    ...
    public class CT_TickMark
    {
        ...
        public static CT_TickMark Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_TickMark ctObj = new CT_TickMark();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_TickMark)Enum.Parse(typeof(ST_TickMark), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_TickLblPos
    {
        ...
        public static CT_TickLblPos Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_TickLblPos ctObj = new CT_TickLblPos();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_TickLblPos)Enum.Parse(typeof(ST_TickLblPos), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    {
        public static CT_Crosses Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Crosses ctObj = new CT_Crosses();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_Crosses)Enum.Parse(typeof(ST_Crosses), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_Skip
    {
        ...
        public static CT_Skip Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    {
        public static CT_TimeUnit Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_TimeUnit ctObj = new CT_TimeUnit();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_TimeUnit)Enum.Parse(typeof(ST_TimeUnit), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_DateAx
    {
        ...
        public static CT_DateAx Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_LblOffset
    {
        ...
        public static CT_LblOffset Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_AxisUnit
    {
        ...
        private double valField;
        public static CT_AxisUnit Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    {
        public static CT_LblAlgn Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_LblAlgn ctObj = new CT_LblAlgn();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_LblAlgn)Enum.Parse(typeof(ST_LblAlgn), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_CatAx
    {
        ...
        public static CT_CatAx Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "axId")
                    ...
                    ctObj.auto = CT_Boolean.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "lblAlgn")
                    ...
                    ctObj.tickMarkSkip = CT_Skip.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "noMultiLvlLbl")
    ...
    public class CT_DispUnitsLbl
    {
        ...
        public static CT_DispUnitsLbl Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "layout")
                    ctObj.layout = CT_Layout.Parse(childNode, namespaceManager);
    ...
    public class CT_DispUnits
    {
        ...
        internal static CT_DispUnits Parse(XElement childNode, XmlNamespaceManager namespaceManager)
        {
    ...
    public class CT_CrossBetween
    {
        ...
        public static CT_CrossBetween Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_CrossBetween ctObj = new CT_CrossBetween();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_CrossBetween)Enum.Parse(typeof(ST_CrossBetween), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_ValAx
    {
        ...
        public static CT_ValAx Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "axId")
                    ...
                    ctObj.crossesAt = CT_Double.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "crossBetween")
                    ctObj.crossBetween = CT_CrossBetween.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "majorUnit")
                    ctObj.majorUnit = CT_AxisUnit.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "minorUnit")
                    ctObj.minorUnit = CT_AxisUnit.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "dispUnits")
    ...
    public class CT_SerTx
    {
        ...
        public static CT_SerTx Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_DPt
    {
        ...
        private List<CT_Extension> extLstField;
        public static CT_DPt Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Marker
    {
        ...
        public static CT_Marker Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "symbol")
    ...
    public class CT_MarkerStyle
    {
        ...
        public static CT_MarkerStyle Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_MarkerStyle ctObj = new CT_MarkerStyle();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_MarkerStyle)Enum.Parse(typeof(ST_MarkerStyle), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_MarkerSize
    {
        ...
        public static CT_MarkerSize Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_PictureOptions
    {
        ...
        public static CT_PictureOptions Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    {
        public static CT_PictureFormat Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_PictureFormat ctObj = new CT_PictureFormat();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_PictureFormat)Enum.Parse(typeof(ST_PictureFormat), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    {
        public static CT_PictureStackUnit Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_DLbls
    {
        ...
        public static CT_DLbls Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "dLblPos")
    ...
    public class CT_DLbl
    {
        ...
        public static CT_DLbl Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "idx")
                    ...
                    ctObj.layout = CT_Layout.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "dLblPos")
                    ctObj.dLblPos = CT_DLblPos.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "numFmt")
                    ctObj.numFmt = CT_NumFmt.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "spPr")
    ...
    public class CT_DLblPos
    {
        ...
        public static CT_DLblPos Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_DLblPos ctObj = new CT_DLblPos();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_DLblPos)Enum.Parse(typeof(ST_DLblPos), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_Trendline
    {
        ...
        public static CT_Trendline Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "name")
                    ctObj.name = childNode.Value;
                else if (childNode.Name.LocalName == "spPr")
                    ctObj.spPr = CT_ShapeProperties.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "trendlineType")
    ...
    public class CT_TrendlineType
    {
        ...
        public static CT_TrendlineType Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_TrendlineType ctObj = new CT_TrendlineType();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_TrendlineType)Enum.Parse(typeof(ST_TrendlineType), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_Order
    {
        ...
        private byte valField;
        public static CT_Order Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Period
    {
        ...
        public static CT_Period Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_TrendlineLbl
    {
        ...
        public static CT_TrendlineLbl Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_ErrBars
    {
        ...
        public static CT_ErrBars Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    {
        public static CT_ErrDir Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_ErrDir ctObj = new CT_ErrDir();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_ErrDir)Enum.Parse(typeof(ST_ErrDir), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    {
        public static CT_ErrBarType Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_ErrBarType ctObj = new CT_ErrBarType();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_ErrBarType)Enum.Parse(typeof(ST_ErrBarType), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_ErrValType
    {
        ...
        public static CT_ErrValType Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_ErrValType ctObj = new CT_ErrValType();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_ErrValType)Enum.Parse(typeof(ST_ErrValType), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_NumDataSource
    {
        ...
        public static CT_NumDataSource Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "numLit")
                    ctObj.numLit = CT_NumData.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "numRef")
    ...
    public class CT_NumData
    {
        ...
        private List<CT_Extension> extLstField;
        public static CT_NumData Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "formatCode")
                    ctObj.formatCode = childNode.Value;
                else if (childNode.Name.LocalName == "ptCount")
                    ctObj.ptCount = CT_UnsignedInt.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "pt")
    ...
    public class CT_NumVal
    {
        ...
        private string formatCodeField;
        public static CT_NumVal Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_NumRef
    {
        ...
        public static CT_NumRef Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "f")
                    ctObj.f = childNode.Value;
                else if (childNode.Name.LocalName == "numCache")
    ...
    public class CT_AxDataSource
    {
        ...
        CT_StrRef strRefField;
        public static CT_AxDataSource Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "numLit")
                    ...
                    ctObj.numRef = CT_NumRef.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "strLit")
                    ctObj.strLit = CT_StrData.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "strRef")
                    ctObj.strRef = CT_StrRef.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "multiLvlStrRef")
    ...
    {
        public static CT_MultiLvlStrRef Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "f")
                    ctObj.f = childNode.Value;
                else if (childNode.Name.LocalName == "multiLvlStrCache")
    ...
    public class CT_MultiLvlStrData
    {
        ...
        public static CT_MultiLvlStrData Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_BandFmt
    {
        ...
        public static CT_BandFmt Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_SurfaceChart
    {
        ...
        public static CT_SurfaceChart Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_SecondPieSize
    {
        ...
        public static CT_SecondPieSize Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_SplitType
    {
        ...
        public static CT_SplitType Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_SplitType ctObj = new CT_SplitType();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_SplitType)Enum.Parse(typeof(ST_SplitType), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_GapAmount
    {
        ...
        public static CT_GapAmount Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Shape
    {
        ...
        public static CT_Shape Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("val") != null)
                ctObj.val = (ST_Shape)Enum.Parse(typeof(ST_Shape), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    {
        public static CT_Overlap Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Overlap ctObj = new CT_Overlap();
            if (node.Attribute("val") != null)
                ctObj.val = XmlHelper.ReadSByte(node.Attribute("val"));
            return ctObj;
        }
    ...
    public class CT_Grouping
    {
        ...
        public static CT_Grouping Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Grouping ctObj = new CT_Grouping();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_Grouping)Enum.Parse(typeof(ST_Grouping), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_PlotArea
    {
        ...
        public static CT_PlotArea Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Perspective
    {
        ...
        public static CT_Perspective Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_DepthPercent
    {
        ...
        public static CT_DepthPercent Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_RotY
    {
        ...
        public static CT_RotY Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    {
        public static CT_HPercent Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_RotX
    {
        ...
        public static CT_RotX Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_View3D
    {
        ...
        public static CT_View3D Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_PivotFmt
    {
        ...
        public static CT_PivotFmt Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Chart
    {
        ...
        public static CT_Chart Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Protection
    {
        ...
        public static CT_Protection Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "chartObject")
                    ctObj.chartObject = CT_Boolean.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "data")
                    ctObj.data = CT_Boolean.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "formatting")
                ...
                else if (childNode.Name.LocalName == "userInterface")
    ...
    public class CT_PivotSource
    {
        ...
        public static CT_PivotSource Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "name")
                    ctObj.name = childNode.Value;
                else if (childNode.Name.LocalName == "fmtId")
    ...
    public class CT_TextLanguageID
    {
        ...
        public static CT_TextLanguageID Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
