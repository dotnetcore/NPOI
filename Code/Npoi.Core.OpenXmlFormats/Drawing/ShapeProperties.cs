...
namespace Npoi.Core.OpenXmlFormats.Dml
{
    ...
    public class CT_ConnectorLocking
    {
        ...
        public static CT_ConnectorLocking Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.noGrp = XmlHelper.ReadBool(node.Attribute("noGrp"));
            ctObj.noSelect = XmlHelper.ReadBool(node.Attribute("noSelect"));
            ctObj.noRot = XmlHelper.ReadBool(node.Attribute("noRot"));
            ctObj.noChangeAspect = XmlHelper.ReadBool(node.Attribute("noChangeAspect"));
            ctObj.noMove = XmlHelper.ReadBool(node.Attribute("noMove"));
            ctObj.noResize = XmlHelper.ReadBool(node.Attribute("noResize"));
            ctObj.noEditPoints = XmlHelper.ReadBool(node.Attribute("noEditPoints"));
            ctObj.noAdjustHandles = XmlHelper.ReadBool(node.Attribute("noAdjustHandles"));
            ctObj.noChangeArrowheads = XmlHelper.ReadBool(node.Attribute("noChangeArrowheads"));
            ctObj.noChangeShapeType = XmlHelper.ReadBool(node.Attribute("noChangeShapeType"));
    ...
    public class CT_PictureLocking
    {
        ...
        public static CT_PictureLocking Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.noChangeArrowheads = XmlHelper.ReadBool(node.Attribute("noChangeArrowheads"));
            ctObj.noChangeShapeType = XmlHelper.ReadBool(node.Attribute("noChangeShapeType"));
            ctObj.noCrop = XmlHelper.ReadBool(node.Attribute("noCrop"));
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "extLst")
                    ctObj.extLst = CT_OfficeArtExtensionList.Parse(childNode, namespaceManager);
    ...
    public class CT_GraphicalObjectFrameLocking
    {
        ...
        public static CT_GraphicalObjectFrameLocking Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.noGrp = XmlHelper.ReadBool(node.Attribute("noGrp"));
            ctObj.noDrilldown = XmlHelper.ReadBool(node.Attribute("noDrilldown"));
            ctObj.noSelect = XmlHelper.ReadBool(node.Attribute("noSelect"));
            ctObj.noChangeAspect = XmlHelper.ReadBool(node.Attribute("noChangeAspect"));
            ctObj.noMove = XmlHelper.ReadBool(node.Attribute("noMove"));
            ctObj.noResize = XmlHelper.ReadBool(node.Attribute("noResize"));
    ...
    {
        public static CT_NonVisualConnectorProperties Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_NonVisualGroupDrawingShapeProps
    {
        ...
        public static CT_NonVisualGroupDrawingShapeProps Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "grpSpLocks")
    ...
    public class CT_ShapeLocking
    {
        ...
        public static CT_ShapeLocking Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.noChangeArrowheads = XmlHelper.ReadBool(node.Attribute("noChangeArrowheads"));
            ctObj.noChangeShapeType = XmlHelper.ReadBool(node.Attribute("noChangeShapeType"));
            ctObj.noTextEdit = XmlHelper.ReadBool(node.Attribute("noTextEdit"));
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "extLst")
                    ctObj.extLst = CT_OfficeArtExtensionList.Parse(childNode, namespaceManager);
    ...
    public class CT_GroupLocking
    {
        ...
        public static CT_GroupLocking Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.noGrp = XmlHelper.ReadBool(node.Attribute("noGrp"));
            ctObj.noUngrp = XmlHelper.ReadBool(node.Attribute("noUngrp"));
            ctObj.noSelect = XmlHelper.ReadBool(node.Attribute("noSelect"));
            ctObj.noRot = XmlHelper.ReadBool(node.Attribute("noRot"));
            ctObj.noChangeAspect = XmlHelper.ReadBool(node.Attribute("noChangeAspect"));
            ctObj.noMove = XmlHelper.ReadBool(node.Attribute("noMove"));
