...
namespace NPOI.OpenXmlFormats.Dml
{
    ...
    public class CT_OfficeStyleSheet
    {
        ...
        public static CT_OfficeStyleSheet Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
