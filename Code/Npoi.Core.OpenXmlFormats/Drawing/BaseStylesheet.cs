...
namespace Npoi.Core.OpenXmlFormats.Dml
{
    ...
    public class CT_ColorScheme
    {
        ...
        public static CT_ColorScheme Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_CustomColor
    {
        ...
        private string nameField;
        public static CT_CustomColor Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_SupplementalFont
    {
        ...
        public static CT_SupplementalFont Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_SupplementalFont ctObj = new CT_SupplementalFont();
            ctObj.script = XmlHelper.ReadString(node.Attribute("script"));
    ...
    public class CT_FontCollection
    {
        ...
        private CT_OfficeArtExtensionList extLstField;
        public static CT_FontCollection Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "latin")
                    ...
                    ctObj.extLst = CT_OfficeArtExtensionList.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "font")
    ...
    public class CT_EffectStyleItem
    {
        ...
        public static CT_EffectStyleItem Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "effectLst")
    ...
    public class CT_FontScheme
    {
        ...
        public static CT_FontScheme Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "majorFont")
                    ctObj.majorFont = CT_FontCollection.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "minorFont")
    ...
    public class CT_FillStyleList
    {
        ...
        public static CT_FillStyleList Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "blipFill")
    ...
    {
        public static CT_BackgroundFillStyleList Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_StyleMatrix
    {
        ...
        private string nameField;
        public static CT_StyleMatrix Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_BaseStyles
    {
        ...
        private CT_OfficeArtExtensionList extLstField;
        public static CT_BaseStyles Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "fontScheme")
                    ctObj.fontScheme = CT_FontScheme.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "fmtScheme")
