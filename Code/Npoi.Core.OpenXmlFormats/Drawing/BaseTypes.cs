...
namespace Npoi.Core.OpenXmlFormats.Dml
{
	...
	public class CT_OfficeArtExtension
	{
		...
		public static CT_OfficeArtExtension Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
	...
	public class CT_Point2D
	{
		...
		public static CT_Point2D Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			CT_Point2D ctObj = new CT_Point2D();
			ctObj.x = XmlHelper.ReadLong(node.Attribute("x"));
			ctObj.y = XmlHelper.ReadLong(node.Attribute("y"));
			return ctObj;
		}
	...
	public class CT_PositiveSize2D
	{
		...
		public static CT_PositiveSize2D Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			CT_PositiveSize2D ctObj = new CT_PositiveSize2D();
			ctObj.cx = XmlHelper.ReadLong(node.Attribute("cx"));
			ctObj.cy = XmlHelper.ReadLong(node.Attribute("cy"));
			return ctObj;
		}
	...
	public class CT_SRgbColor
	{
		...
		public static CT_SRgbColor Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			CT_SRgbColor ctObj = new CT_SRgbColor();
			ctObj.val = XmlHelper.ReadBytes(node.Attribute("val"));
			foreach (XElement childNode in node.ChildElements())
			{
				if (childNode.Name.LocalName == "alpha")
					ctObj.ItemsElementName.Add(EG_ColorTransform.alpha);
	...
	public class CT_HslColor
	{
		...
		public static CT_HslColor Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			CT_HslColor ctObj = new CT_HslColor();
			ctObj.hue = XmlHelper.ReadInt(node.Attribute("hue"));
			ctObj.sat = XmlHelper.ReadInt(node.Attribute("sat"));
			ctObj.lum = XmlHelper.ReadInt(node.Attribute("lum"));
			foreach (XElement childNode in node.ChildElements())
			{
				if (childNode.Name.LocalName == "alpha")
					ctObj.ItemsElementName.Add(EG_ColorTransform.alpha);
	...
	public class CT_SystemColor
	{
		...
		public static CT_SystemColor Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			CT_SystemColor ctObj = new CT_SystemColor();
			if (node.Attribute("val") != null)
				ctObj.val = (ST_SystemColorVal)Enum.Parse(typeof(ST_SystemColorVal), node.Attribute("val").Value);
			ctObj.lastClr = XmlHelper.ReadBytes(node.Attribute("lastClr"));
	...
	public class CT_SchemeColor
	{
		...
		public static CT_SchemeColor Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			CT_SchemeColor ctObj = new CT_SchemeColor();
			if (node.Attribute("val") != null)
				ctObj.val = (ST_SchemeColorVal)Enum.Parse(typeof(ST_SchemeColorVal), node.Attribute("val").Value);
			foreach (XElement childNode in node.ChildElements())
			{
				if (childNode.Name.LocalName == "alpha")
					ctObj.ItemsElementName.Add(EG_ColorTransform.alpha);
	...
	public class CT_PresetColor
	{
		...
		public static CT_PresetColor Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			CT_PresetColor ctObj = new CT_PresetColor();
			if (node.Attribute("val") != null)
				ctObj.val = (ST_PresetColorVal)Enum.Parse(typeof(ST_PresetColorVal), node.Attribute("val").Value);
			foreach (XElement childNode in node.ChildElements())
			{
				if (childNode.Name.LocalName == "alpha")
					ctObj.ItemsElementName.Add(EG_ColorTransform.alpha);
	...
	public class CT_OfficeArtExtensionList
	{
		...
		public static CT_OfficeArtExtensionList Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			...
			foreach (XElement childNode in node.ChildElements())
			{
				if (childNode.Name.LocalName == "ext")
	...
	public class CT_Transform2D
	{
		...
		public static CT_Transform2D Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			CT_Transform2D ctObj = new CT_Transform2D();
			ctObj.rot = XmlHelper.ReadInt(node.Attribute("rot"));
			ctObj.flipH = XmlHelper.ReadBool(node.Attribute("flipH"));
			ctObj.flipV = XmlHelper.ReadBool(node.Attribute("flipV"));
			foreach (XElement childNode in node.ChildElements())
			{
				if (childNode.Name.LocalName == "off")
	...
	public class CT_GroupTransform2D
	{
		...
		public static CT_GroupTransform2D Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			...
			foreach (XElement childNode in node.ChildElements())
			{
				if (childNode.Name.LocalName == "off")
					...
					ctObj.ext = CT_PositiveSize2D.Parse(childNode, namespaceManager);
				else if (childNode.Name.LocalName == "chOff")
					ctObj.chOff = CT_Point2D.Parse(childNode, namespaceManager);
				else if (childNode.Name.LocalName == "chExt")
	...
	public class CT_Point3D
	{
		...
		private long zField;
		public static CT_Point3D Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
	...
	public class CT_Vector3D
	{
		...
		public static CT_Vector3D Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			CT_Vector3D ctObj = new CT_Vector3D();
			ctObj.dx = XmlHelper.ReadLong(node.Attribute("dx"));
			ctObj.dy = XmlHelper.ReadLong(node.Attribute("dy"));
			ctObj.dz = XmlHelper.ReadLong(node.Attribute("dz"));
			return ctObj;
		}
	...
	public class CT_SphereCoords
	{
		...
		public static CT_SphereCoords Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			CT_SphereCoords ctObj = new CT_SphereCoords();
			ctObj.lat = XmlHelper.ReadInt(node.Attribute("lat"));
			ctObj.lon = XmlHelper.ReadInt(node.Attribute("lon"));
			ctObj.rev = XmlHelper.ReadInt(node.Attribute("rev"));
			return ctObj;
		}
	...
	public class CT_RelativeRect
	{
		...
		private int? rField;
		private int? bField;
		public static CT_RelativeRect Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			CT_RelativeRect ctObj = new CT_RelativeRect();
			ctObj.l = XmlHelper.ReadInt(node.Attribute("l"));
			ctObj.t = XmlHelper.ReadInt(node.Attribute("t"));
			ctObj.r = XmlHelper.ReadInt(node.Attribute("r"));
			ctObj.b = XmlHelper.ReadInt(node.Attribute("b"));
			return ctObj;
		}
	...
	public class CT_EmbeddedWAVAudioFile
	{
		...
		public static CT_EmbeddedWAVAudioFile Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			CT_EmbeddedWAVAudioFile ctObj = new CT_EmbeddedWAVAudioFile();
			ctObj.embed = XmlHelper.ReadString(node.Attribute("embed"));
			ctObj.name = XmlHelper.ReadString(node.Attribute("name"));
			ctObj.builtIn = XmlHelper.ReadBool(node.Attribute("builtIn"));
			return ctObj;
		}
	...
	public class CT_Hyperlink
	{
		...
		public static CT_Hyperlink Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			...
			ctObj.invalidUrl = XmlHelper.ReadString(node.Attribute("invalidUrl"));
			ctObj.action = XmlHelper.ReadString(node.Attribute("action"));
			ctObj.tgtFrame = XmlHelper.ReadString(node.Attribute("tgtFrame"));
			ctObj.tooltip = XmlHelper.ReadString(node.Attribute("tooltip"));
			ctObj.history = XmlHelper.ReadBool(node.Attribute("history"));
			ctObj.highlightClick = XmlHelper.ReadBool(node.Attribute("highlightClick"));
			ctObj.endSnd = XmlHelper.ReadBool(node.Attribute("endSnd"));
			foreach (XElement childNode in node.ChildElements())
			{
				if (childNode.Name.LocalName == "snd")
