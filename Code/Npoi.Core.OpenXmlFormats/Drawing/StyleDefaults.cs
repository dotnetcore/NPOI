...
namespace Npoi.Core.OpenXmlFormats.Dml
{
    ...
    public class CT_ObjectStyleDefaults
    {
        ...
        public static CT_ObjectStyleDefaults Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
