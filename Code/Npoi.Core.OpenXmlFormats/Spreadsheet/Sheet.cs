...
namespace Npoi.Core.OpenXmlFormats.Spreadsheet
{
    ...
    {
        public static CT_FunctionGroup Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_FunctionGroups
    {
        ...
        public static CT_FunctionGroups Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_FunctionGroups ctObj = new CT_FunctionGroups();
            ctObj.builtInGroupCount = XmlHelper.ReadUInt(node.Attribute("builtInGroupCount"));
            ctObj.functionGroup = new List<CT_FunctionGroup>();
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "functionGroup")
    ...
    public class CT_OutlinePr
    {
        ...
        public static CT_OutlinePr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_OutlinePr ctObj = new CT_OutlinePr();
            ctObj.applyStyles = XmlHelper.ReadBool(node.Attribute("applyStyles"));
            ctObj.summaryBelow = XmlHelper.ReadBool(node.Attribute("summaryBelow"));
            ctObj.summaryRight = XmlHelper.ReadBool(node.Attribute("summaryRight"));
            ctObj.showOutlineSymbols = XmlHelper.ReadBool(node.Attribute("showOutlineSymbols"));
            return ctObj;
        }
    ...
    public class CT_PageSetUpPr
    {
        ...
        public static CT_PageSetUpPr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_PageSetUpPr ctObj = new CT_PageSetUpPr();
            ctObj.autoPageBreaks = XmlHelper.ReadBool(node.Attribute("autoPageBreaks"));
            ctObj.fitToPage = XmlHelper.ReadBool(node.Attribute("fitToPage"));
            return ctObj;
        }
    ...
    public class CT_SheetDimension
    {
        ...
        public static CT_SheetDimension Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_SheetViews
    {
        ...
        public static CT_SheetViews Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "sheetView")
    ...
    public class CT_SheetView
    {
        ...
        public static CT_SheetView Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_SheetView ctObj = new CT_SheetView();
            ctObj.windowProtection = XmlHelper.ReadBool(node.Attribute("windowProtection"));
            ctObj.showFormulas = XmlHelper.ReadBool(node.Attribute("showFormulas"));
            if (node.Attribute("showGridLines") == null)
                ctObj.showGridLines = true;
            else
                ctObj.showGridLines = XmlHelper.ReadBool(node.Attribute("showGridLines"));
            if (node.Attribute("showRowColHeaders") == null)
                ctObj.showRowColHeaders = true;
            else
                ctObj.showRowColHeaders = XmlHelper.ReadBool(node.Attribute("showRowColHeaders"));
            if (node.Attribute("showZeros") == null)
                ctObj.showZeros = true;
            else
                ctObj.showZeros = XmlHelper.ReadBool(node.Attribute("showZeros"));
            ctObj.rightToLeft = XmlHelper.ReadBool(node.Attribute("rightToLeft"));
            ctObj.tabSelected = XmlHelper.ReadBool(node.Attribute("tabSelected"));
            ctObj.showRuler = XmlHelper.ReadBool(node.Attribute("showRuler"));
            ctObj.showOutlineSymbols = XmlHelper.ReadBool(node.Attribute("showOutlineSymbols"));
            ctObj.defaultGridColor = XmlHelper.ReadBool(node.Attribute("defaultGridColor"));
            if (node.Attribute("showWhiteSpace") == null)
                ctObj.showWhiteSpace = true;
            else
                ctObj.showWhiteSpace = XmlHelper.ReadBool(node.Attribute("showWhiteSpace"));
            if (node.Attribute("view") != null)
                ctObj.view = (ST_SheetViewType)Enum.Parse(typeof(ST_SheetViewType), node.Attribute("view").Value);
            ctObj.topLeftCell = XmlHelper.ReadString(node.Attribute("topLeftCell"));
            ctObj.colorId = XmlHelper.ReadUInt(node.Attribute("colorId"));
            ctObj.zoomScale = XmlHelper.ReadUInt(node.Attribute("zoomScale"));
            ctObj.zoomScaleNormal = XmlHelper.ReadUInt(node.Attribute("zoomScaleNormal"));
            ctObj.zoomScaleSheetLayoutView = XmlHelper.ReadUInt(node.Attribute("zoomScaleSheetLayoutView"));
            ctObj.zoomScalePageLayoutView = XmlHelper.ReadUInt(node.Attribute("zoomScalePageLayoutView"));
            ctObj.workbookViewId = XmlHelper.ReadUInt(node.Attribute("workbookViewId"));
            ctObj.selection = new List<CT_Selection>();
            ctObj.pivotSelection = new List<CT_PivotSelection>();
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "pane")
                    ctObj.pane = CT_Pane.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "extLst")
                    ctObj.extLst = CT_ExtensionList.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "selection")
                    ctObj.selection.Add(CT_Selection.Parse(childNode, namespaceManager));
                else if (childNode.Name.LocalName == "pivotSelection")
    ...
    public class CT_Pane
    {
        ...
        public static CT_Pane Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Pane ctObj = new CT_Pane();
            ctObj.xSplit = XmlHelper.ReadDouble(node.Attribute("xSplit"));
            ctObj.ySplit = XmlHelper.ReadDouble(node.Attribute("ySplit"));
            ctObj.topLeftCell = XmlHelper.ReadString(node.Attribute("topLeftCell"));
            if (node.Attribute("activePane") != null)
                ctObj.activePane = (ST_Pane)Enum.Parse(typeof(ST_Pane), node.Attribute("activePane").Value);
            if (node.Attribute("state") != null)
                ctObj.state = (ST_PaneState)Enum.Parse(typeof(ST_PaneState), node.Attribute("state").Value);
            return ctObj;
        }
    ...
    public class CT_Selection
    {
        ...
        public static CT_Selection Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Selection ctObj = new CT_Selection();
            if (node.Attribute("pane") != null)
                ctObj.pane = (ST_Pane)Enum.Parse(typeof(ST_Pane), node.Attribute("pane").Value);
            ctObj.activeCell = XmlHelper.ReadString(node.Attribute("activeCell"));
            ctObj.activeCellId = XmlHelper.ReadUInt(node.Attribute("activeCellId"));
            ctObj.sqref = XmlHelper.ReadString(node.Attribute("sqref"));
            return ctObj;
        }
    ...
    public class CT_PivotSelection
    {
        ...
        public static CT_PivotSelection Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            if (node.Attribute("pane") != null)
                ctObj.pane = (ST_Pane)Enum.Parse(typeof(ST_Pane), node.Attribute("pane").Value);
            ctObj.showHeader = XmlHelper.ReadBool(node.Attribute("showHeader"));
            ctObj.label = XmlHelper.ReadBool(node.Attribute("label"));
            ctObj.data = XmlHelper.ReadBool(node.Attribute("data"));
            ctObj.extendable = XmlHelper.ReadBool(node.Attribute("extendable"));
            ...
            ctObj.start = XmlHelper.ReadUInt(node.Attribute("start"));
            ctObj.min = XmlHelper.ReadUInt(node.Attribute("min"));
            ctObj.max = XmlHelper.ReadUInt(node.Attribute("max"));
            ctObj.activeRow = XmlHelper.ReadUInt(node.Attribute("activeRow"));
            ctObj.activeCol = XmlHelper.ReadUInt(node.Attribute("activeCol"));
            ctObj.previousRow = XmlHelper.ReadUInt(node.Attribute("previousRow"));
            ctObj.previousCol = XmlHelper.ReadUInt(node.Attribute("previousCol"));
            ctObj.click = XmlHelper.ReadUInt(node.Attribute("click"));
    ...
    public class CT_PivotArea
    {
        ...
        public static CT_PivotArea Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_PivotArea ctObj = new CT_PivotArea();
            ctObj.field = XmlHelper.ReadInt(node.Attribute("field"));
            if (node.Attribute("type") != null)
                ctObj.type = (ST_PivotAreaType)Enum.Parse(typeof(ST_PivotAreaType), node.Attribute("type").Value);
            ctObj.dataOnly = XmlHelper.ReadBool(node.Attribute("dataOnly"));
            ctObj.labelOnly = XmlHelper.ReadBool(node.Attribute("labelOnly"));
            ctObj.grandRow = XmlHelper.ReadBool(node.Attribute("grandRow"));
            ctObj.grandCol = XmlHelper.ReadBool(node.Attribute("grandCol"));
            ctObj.cacheIndex = XmlHelper.ReadBool(node.Attribute("cacheIndex"));
            ctObj.outline = XmlHelper.ReadBool(node.Attribute("outline"));
            ctObj.offset = XmlHelper.ReadString(node.Attribute("offset"));
            ctObj.collapsedLevelsAreSubtotals = XmlHelper.ReadBool(node.Attribute("collapsedLevelsAreSubtotals"));
            if (node.Attribute("axis") != null)
                ctObj.axis = (ST_Axis)Enum.Parse(typeof(ST_Axis), node.Attribute("axis").Value);
            ctObj.fieldPosition = XmlHelper.ReadUInt(node.Attribute("fieldPosition"));
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "references")
    ...
    public class CT_PivotAreaReferences
    {
        ...
        public static CT_PivotAreaReferences Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "reference")
    ...
    public class CT_PivotAreaReference
    {
        ...
        public static CT_PivotAreaReference Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            ctObj.count = XmlHelper.ReadUInt(node.Attribute("count"));
            ctObj.selected = XmlHelper.ReadBool(node.Attribute("selected"));
            ctObj.byPosition = XmlHelper.ReadBool(node.Attribute("byPosition"));
            ctObj.relative = XmlHelper.ReadBool(node.Attribute("relative"));
    ...
    public class CT_SheetFormatPr
    {
        ...
        public static CT_SheetFormatPr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_SheetFormatPr ctObj = new CT_SheetFormatPr();
            ctObj.baseColWidth = XmlHelper.ReadUInt(node.Attribute("baseColWidth"));
            ctObj.defaultColWidth = XmlHelper.ReadDouble(node.Attribute("defaultColWidth"));
            ctObj.defaultRowHeight = XmlHelper.ReadDouble(node.Attribute("defaultRowHeight"));
            ctObj.customHeight = XmlHelper.ReadBool(node.Attribute("customHeight"));
            ctObj.zeroHeight = XmlHelper.ReadBool(node.Attribute("zeroHeight"));
            ctObj.thickTop = XmlHelper.ReadBool(node.Attribute("thickTop"));
            ctObj.outlineLevelRow = XmlHelper.ReadByte(node.Attribute("outlineLevelRow"));
            ctObj.outlineLevelCol = XmlHelper.ReadByte(node.Attribute("outlineLevelCol"));
            ctObj.thickBottom = XmlHelper.ReadBool(node.Attribute("thickBottom"));
            return ctObj;
        }
    ...
    public class CT_CellFormula
    {
        ...
        public static CT_CellFormula Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_CellFormula ctObj = new CT_CellFormula();
            if (node.Attribute("t") != null)
                ctObj.t = (ST_CellFormulaType)Enum.Parse(typeof(ST_CellFormulaType), node.Attribute("t").Value);
            else
                ctObj.t = ST_CellFormulaType.normal;
            ctObj.aca = XmlHelper.ReadBool(node.Attribute("aca"));
            ctObj.@ref = XmlHelper.ReadString(node.Attribute("ref"));
            ctObj.dt2D = XmlHelper.ReadBool(node.Attribute("dt2D"));
            ctObj.dtr = XmlHelper.ReadBool(node.Attribute("dtr"));
            ctObj.del1 = XmlHelper.ReadBool(node.Attribute("del1"));
            ctObj.del2 = XmlHelper.ReadBool(node.Attribute("del2"));
            ctObj.r1 = XmlHelper.ReadString(node.Attribute("r1"));
            ctObj.r2 = XmlHelper.ReadString(node.Attribute("r2"));
            ctObj.ca = XmlHelper.ReadBool(node.Attribute("ca"));
            ctObj.si = XmlHelper.ReadUInt(node.Attribute("si"));
            ctObj.bx = XmlHelper.ReadBool(node.Attribute("bx"));
            ctObj.Value = node.Value.Replace("\r","");
            return ctObj;
        }
    ...
    public class CT_SheetCalcPr
    {
        ...
        public static CT_SheetCalcPr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_SheetProtection
    {
        ...
        public static CT_SheetProtection Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_SheetProtection ctObj = new CT_SheetProtection();
            ctObj.password = XmlHelper.ReadString(node.Attribute("password"));
            ctObj.sheet = XmlHelper.ReadBool(node.Attribute("sheet"));
            ctObj.objects = XmlHelper.ReadBool(node.Attribute("objects"));
            ctObj.scenarios = XmlHelper.ReadBool(node.Attribute("scenarios"));
            ctObj.formatCells = XmlHelper.ReadBool(node.Attribute("formatCells"));
            ctObj.formatColumns = XmlHelper.ReadBool(node.Attribute("formatColumns"));
            ctObj.formatRows = XmlHelper.ReadBool(node.Attribute("formatRows"));
            ctObj.insertColumns = XmlHelper.ReadBool(node.Attribute("insertColumns"));
            ctObj.insertRows = XmlHelper.ReadBool(node.Attribute("insertRows"));
            ctObj.insertHyperlinks = XmlHelper.ReadBool(node.Attribute("insertHyperlinks"));
            ctObj.deleteColumns = XmlHelper.ReadBool(node.Attribute("deleteColumns"));
            ctObj.deleteRows = XmlHelper.ReadBool(node.Attribute("deleteRows"));
            ctObj.selectLockedCells = XmlHelper.ReadBool(node.Attribute("selectLockedCells"));
            ctObj.sort = XmlHelper.ReadBool(node.Attribute("sort"));
            ctObj.autoFilter = XmlHelper.ReadBool(node.Attribute("autoFilter"));
            ctObj.pivotTables = XmlHelper.ReadBool(node.Attribute("pivotTables"));
            ctObj.selectUnlockedCells = XmlHelper.ReadBool(node.Attribute("selectUnlockedCells"));
            return ctObj;
        }
    ...
    public class CT_ProtectedRange
    {
        ...
        public static CT_ProtectedRange Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_ProtectedRange ctObj = new CT_ProtectedRange();
            ctObj.password = XmlHelper.ReadBytes(node.Attribute("password"));
            ctObj.name = XmlHelper.ReadString(node.Attribute("name"));
            ctObj.securityDescriptor = XmlHelper.ReadString(node.Attribute("securityDescriptor"));
            ctObj.sqref = XmlHelper.ReadString(node.Attribute("sqref"));
            return ctObj;
        }
    ...
    public class CT_Scenarios
    {
        ...
        public static CT_Scenarios Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Scenarios ctObj = new CT_Scenarios();
            ctObj.current = XmlHelper.ReadUInt(node.Attribute("current"));
            ctObj.show = XmlHelper.ReadUInt(node.Attribute("show"));
            ctObj.scenario = new List<CT_Scenario>();
            ctObj.sqref = XmlHelper.ReadString(node.Attribute("sqref"));
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "scenario")
    ...
    public class CT_Scenario
    {
        ...
        public static CT_Scenario Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_InputCells
    {
        ...
        public static CT_InputCells Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_InputCells ctObj = new CT_InputCells();
            ctObj.r = XmlHelper.ReadString(node.Attribute("r"));
            ctObj.deleted = XmlHelper.ReadBool(node.Attribute("deleted"));
            ctObj.undone = XmlHelper.ReadBool(node.Attribute("undone"));
    ...
    public class CT_DataConsolidate
    {
        ...
        public static CT_DataConsolidate Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_DataConsolidate ctObj = new CT_DataConsolidate();
            if (node.Attribute("function") != null)
                ctObj.function = (ST_DataConsolidateFunction)Enum.Parse(typeof(ST_DataConsolidateFunction), node.Attribute("function").Value);
            ctObj.leftLabels = XmlHelper.ReadBool(node.Attribute("leftLabels"));
            ctObj.topLabels = XmlHelper.ReadBool(node.Attribute("topLabels"));
            ctObj.link = XmlHelper.ReadBool(node.Attribute("link"));
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "dataRefs")
    ...
    public class CT_DataRefs
    {
        ...
        public static CT_DataRefs Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "dataRef")
    ...
    public class CT_DataRef
    {
        ...
        public static CT_DataRef Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_CustomSheetView
    {
        ...
        public static CT_CustomSheetView Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_CustomSheetView ctObj = new CT_CustomSheetView();
            ctObj.guid = XmlHelper.ReadString(node.Attribute("guid"));
            ctObj.scale = XmlHelper.ReadUInt(node.Attribute("scale"));
            ctObj.colorId = XmlHelper.ReadUInt(node.Attribute("colorId"));
            ctObj.showPageBreaks = XmlHelper.ReadBool(node.Attribute("showPageBreaks"));
            ctObj.showFormulas = XmlHelper.ReadBool(node.Attribute("showFormulas"));
            if (node.Attribute("showGridLines") == null)
                ctObj.showGridLines = true;
            else
            ...
            ctObj.showRowCol = XmlHelper.ReadBool(node.Attribute("showRowCol"));
            ctObj.outlineSymbols = XmlHelper.ReadBool(node.Attribute("outlineSymbols"));
            ctObj.zeroValues = XmlHelper.ReadBool(node.Attribute("zeroValues"));
            ctObj.fitToPage = XmlHelper.ReadBool(node.Attribute("fitToPage"));
            ctObj.printArea = XmlHelper.ReadBool(node.Attribute("printArea"));
            ctObj.filter = XmlHelper.ReadBool(node.Attribute("filter"));
            ctObj.showAutoFilter = XmlHelper.ReadBool(node.Attribute("showAutoFilter"));
            ctObj.hiddenRows = XmlHelper.ReadBool(node.Attribute("hiddenRows"));
            ctObj.hiddenColumns = XmlHelper.ReadBool(node.Attribute("hiddenColumns"));
            if (node.Attribute("state") != null)
                ctObj.state = (ST_SheetState)Enum.Parse(typeof(ST_SheetState), node.Attribute("state").Value);
            ctObj.filterUnique = XmlHelper.ReadBool(node.Attribute("filterUnique"));
            if (node.Attribute("view") != null)
                ctObj.view = (ST_SheetViewType)Enum.Parse(typeof(ST_SheetViewType), node.Attribute("view").Value);
            ctObj.showRuler = XmlHelper.ReadBool(node.Attribute("showRuler"));
            ctObj.topLeftCell = XmlHelper.ReadString(node.Attribute("topLeftCell"));
    ...
    public class CT_PageBreak
    {
        ...
        public static CT_PageBreak Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_PageBreak ctObj = new CT_PageBreak();
            ctObj.count = XmlHelper.ReadUInt(node.Attribute("count"));
            ctObj.manualBreakCount = XmlHelper.ReadUInt(node.Attribute("manualBreakCount"));
            ctObj.brk = new List<CT_Break>();
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "brk")
    ...
    public class CT_Break
    {
        ...
        public static CT_Break Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            ctObj.min = XmlHelper.ReadUInt(node.Attribute("min"));
            ctObj.max = XmlHelper.ReadUInt(node.Attribute("max"));
            ctObj.man = XmlHelper.ReadBool(node.Attribute("man"));
            ctObj.pt = XmlHelper.ReadBool(node.Attribute("pt"));
            return ctObj;
        }
    ...
    public class CT_PageMargins
    {
        ...
        public static CT_PageMargins Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            ctObj.header = XmlHelper.ReadDouble(node.Attribute("header"));
            ctObj.footer = XmlHelper.ReadDouble(node.Attribute("footer"));
            return ctObj;
        }
    ...
    public class CT_PrintOptions
    {
        ...
        public static CT_PrintOptions Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_PrintOptions ctObj = new CT_PrintOptions();
            ctObj.horizontalCentered = XmlHelper.ReadBool(node.Attribute("horizontalCentered"));
            ctObj.verticalCentered = XmlHelper.ReadBool(node.Attribute("verticalCentered"));
            ctObj.headings = XmlHelper.ReadBool(node.Attribute("headings"));
            ctObj.gridLines = XmlHelper.ReadBool(node.Attribute("gridLines"));
            ctObj.gridLinesSet = XmlHelper.ReadBool(node.Attribute("gridLinesSet"));
            return ctObj;
        }
    ...
    public class CT_PageSetup
    {
        ...
        public static CT_PageSetup Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_PageSetup ctObj = new CT_PageSetup();
            ctObj.paperSize = XmlHelper.ReadUInt(node.Attribute("paperSize"));
            ctObj.scale = XmlHelper.ReadUInt(node.Attribute("scale"));
            ctObj.firstPageNumber = XmlHelper.ReadUInt(node.Attribute("firstPageNumber"));
            ctObj.fitToWidth = XmlHelper.ReadUInt(node.Attribute("fitToWidth"));
            ctObj.fitToHeight = XmlHelper.ReadUInt(node.Attribute("fitToHeight"));
            if (node.Attribute("pageOrder") != null)
                ctObj.pageOrder = (ST_PageOrder)Enum.Parse(typeof(ST_PageOrder), node.Attribute("pageOrder").Value);
            if (node.Attribute("orientation") != null)
                ctObj.orientation = (ST_Orientation)Enum.Parse(typeof(ST_Orientation), node.Attribute("orientation").Value);
            if (node.Attribute("usePrinterDefaults") == null)
                ctObj.usePrinterDefaults = true;
            else
                ctObj.usePrinterDefaults = XmlHelper.ReadBool(node.Attribute("usePrinterDefaults"));
            ctObj.blackAndWhite = XmlHelper.ReadBool(node.Attribute("blackAndWhite"));
            ctObj.draft = XmlHelper.ReadBool(node.Attribute("draft"));
            if (node.Attribute("cellComments") != null)
                ctObj.cellComments = (ST_CellComments)Enum.Parse(typeof(ST_CellComments), node.Attribute("cellComments").Value);
            ctObj.useFirstPageNumber = XmlHelper.ReadBool(node.Attribute("useFirstPageNumber"));
            if (node.Attribute("errors") != null)
                ctObj.errors = (ST_PrintError)Enum.Parse(typeof(ST_PrintError), node.Attribute("errors").Value);
            ctObj.horizontalDpi = XmlHelper.ReadUInt(node.Attribute("horizontalDpi"));
            ctObj.verticalDpi = XmlHelper.ReadUInt(node.Attribute("verticalDpi"));
            ctObj.copies = XmlHelper.ReadUInt(node.Attribute("copies"));
            ctObj.id = XmlHelper.ReadString(node.Attribute((XNamespace)PackageNamespaces.SCHEMA_RELATIONSHIPS + "id"));
            return ctObj;
        }
    ...
    public class CT_HeaderFooter
    {
        ...
        public static CT_HeaderFooter Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_HeaderFooter ctObj = new CT_HeaderFooter();
            ctObj.differentOddEven = XmlHelper.ReadBool(node.Attribute("differentOddEven"));
            ctObj.differentFirst = XmlHelper.ReadBool(node.Attribute("differentFirst"));
            if (node.Attribute("scaleWithDoc")!=null)
                ctObj.scaleWithDoc = XmlHelper.ReadBool(node.Attribute("scaleWithDoc"));
            if (node.Attribute("alignWithMargins") != null)
                ctObj.alignWithMargins = XmlHelper.ReadBool(node.Attribute("alignWithMargins"));
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "oddHeader")
                    ctObj.oddHeader = childNode.Value;
                else if (childNode.Name.LocalName == "oddFooter")
                    ctObj.oddFooter = childNode.Value;
                else if (childNode.Name.LocalName == "evenHeader")
                    ctObj.evenHeader = childNode.Value;
                else if (childNode.Name.LocalName == "evenFooter")
                    ctObj.evenFooter = childNode.Value;
                else if (childNode.Name.LocalName == "firstHeader")
                    ctObj.firstHeader = childNode.Value;
                else if (childNode.Name.LocalName == "firstFooter")
                    ctObj.firstFooter = childNode.Value;
            }
            return ctObj;
        }
    ...
    public class CT_ConditionalFormatting
    {
        ...
        private string sqrefField;
        public static CT_ConditionalFormatting Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "extLst")
                    ctObj.extLst = CT_ExtensionList.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "cfRule")
    ...
    public class CT_CfRule
    {
        ...
        public static CT_CfRule Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_CfRule ctObj = new CT_CfRule();
            if (node.Attribute("type") != null)
                ctObj.type = (ST_CfType)Enum.Parse(typeof(ST_CfType), node.Attribute("type").Value);
            if(node.Attribute("dxfId")!=null)
            {
                ctObj.dxfId = XmlHelper.ReadUInt(node.Attribute("dxfId"));
                ctObj.dxfIdFieldSpecified = true;
            }
            ctObj.priority = XmlHelper.ReadInt(node.Attribute("priority"));
            ctObj.stopIfTrue = XmlHelper.ReadBool(node.Attribute("stopIfTrue"));
            if (node.Attribute("aboveAverage")!=null)
                ctObj.aboveAverage = XmlHelper.ReadBool(node.Attribute("aboveAverage"));
            ctObj.percent = XmlHelper.ReadBool(node.Attribute("percent"));
            ctObj.bottom = XmlHelper.ReadBool(node.Attribute("bottom"));
            if (node.Attribute("operator") != null)
                ctObj.@operator = (ST_ConditionalFormattingOperator)Enum.Parse(typeof(ST_ConditionalFormattingOperator), node.Attribute("operator").Value);
            ctObj.text = XmlHelper.ReadString(node.Attribute("text"));
            if (node.Attribute("timePeriod") != null)
                ctObj.timePeriod = (ST_TimePeriod)Enum.Parse(typeof(ST_TimePeriod), node.Attribute("timePeriod").Value);
            ctObj.rank = XmlHelper.ReadUInt(node.Attribute("rank"));
            ctObj.stdDev = XmlHelper.ReadInt(node.Attribute("stdDev"));
            ctObj.equalAverage = XmlHelper.ReadBool(node.Attribute("equalAverage"));
            ctObj.formula = new List<String>();
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "colorScale")
                    ctObj.colorScale = CT_ColorScale.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "dataBar")
                    ctObj.dataBar = CT_DataBar.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "iconSet")
                    ctObj.iconSet = CT_IconSet.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "extLst")
                    ctObj.extLst = CT_ExtensionList.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "formula")
                    ctObj.formula.Add(childNode.Value);
            }
            return ctObj;
        }
    ...
    public class CT_ColorScale
    {
        ...
        public static CT_ColorScale Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "cfvo")
    ...
    public class CT_Cfvo
    {
        ...
        public static CT_Cfvo Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Cfvo ctObj = new CT_Cfvo();
            if (node.Attribute("type") != null)
                ctObj.type = (ST_CfvoType)Enum.Parse(typeof(ST_CfvoType), node.Attribute("type").Value);
            ctObj.val = XmlHelper.ReadString(node.Attribute("val"));
            ctObj.gte = XmlHelper.ReadBool(node.Attribute("gte"));
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "extLst")
                    ctObj.extLst = CT_ExtensionList.Parse(childNode, namespaceManager);
    ...
    public class CT_DataBar
    {
        ...
        public static CT_DataBar Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_DataBar ctObj = new CT_DataBar();
            ctObj.minLength = XmlHelper.ReadUInt(node.Attribute("minLength"));
            ctObj.maxLength = XmlHelper.ReadUInt(node.Attribute("maxLength"));
            if (node.Attribute("showValue") == null)
                ctObj.showValue = true;
            else
                ctObj.showValue = XmlHelper.ReadBool(node.Attribute("showValue"));
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "cfvo")
                    ctObj.cfvo.Add(CT_Cfvo.Parse(childNode, namespaceManager));
            }
            return ctObj;
        }
    ...
    public class CT_IconSet
    {
        ...
        public static CT_IconSet Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_IconSet ctObj = new CT_IconSet();
            if (node.Attribute("iconSet") != null)
                ctObj.iconSet = (ST_IconSetType)Enum.Parse(typeof(ST_IconSetType), "Item"+node.Attribute("iconSet").Value);
            ctObj.showValue = XmlHelper.ReadBool(node.Attribute("showValue"));
            ctObj.percent = XmlHelper.ReadBool(node.Attribute("percent"));
            ctObj.reverse = XmlHelper.ReadBool(node.Attribute("reverse"));
            ctObj.cfvo = new List<CT_Cfvo>();
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "cfvo")
    ...
    public class CT_DataValidations
    {
        ...
        public static CT_DataValidations Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_DataValidations ctObj = new CT_DataValidations();
            ctObj.disablePrompts = XmlHelper.ReadBool(node.Attribute("disablePrompts"));
            ctObj.xWindow = XmlHelper.ReadUInt(node.Attribute("xWindow"));
            ctObj.yWindow = XmlHelper.ReadUInt(node.Attribute("yWindow"));
            ctObj.count = XmlHelper.ReadUInt(node.Attribute("count"));
            ctObj.dataValidation = new List<CT_DataValidation>();
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "dataValidation")
    ...
    public class CT_DataValidation
    {
        ...
        private string sqrefField;
        public static CT_DataValidation Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_DataValidation ctObj = new CT_DataValidation();
            if (node.Attribute("type") != null)
                ctObj.type = (ST_DataValidationType)Enum.Parse(typeof(ST_DataValidationType), node.Attribute("type").Value);
            if (node.Attribute("errorStyle") != null)
                ctObj.errorStyle = (ST_DataValidationErrorStyle)Enum.Parse(typeof(ST_DataValidationErrorStyle), node.Attribute("errorStyle").Value);
            if (node.Attribute("imeMode") != null)
                ctObj.imeMode = (ST_DataValidationImeMode)Enum.Parse(typeof(ST_DataValidationImeMode), node.Attribute("imeMode").Value);
            if (node.Attribute("operator") != null)
                ctObj.@operator = (ST_DataValidationOperator)Enum.Parse(typeof(ST_DataValidationOperator), node.Attribute("operator").Value);
            ctObj.allowBlank = XmlHelper.ReadBool(node.Attribute("allowBlank"));
            ctObj.showDropDown = XmlHelper.ReadBool(node.Attribute("showDropDown"));
            ctObj.showInputMessage = XmlHelper.ReadBool(node.Attribute("showInputMessage"));
            ctObj.showErrorMessage = XmlHelper.ReadBool(node.Attribute("showErrorMessage"));
            ctObj.errorTitle = XmlHelper.ReadString(node.Attribute("errorTitle"));
            ctObj.error = XmlHelper.ReadString(node.Attribute("error"));
            ctObj.promptTitle = XmlHelper.ReadString(node.Attribute("promptTitle"));
            ctObj.prompt = XmlHelper.ReadString(node.Attribute("prompt"));
            ctObj.sqref = XmlHelper.ReadString(node.Attribute("sqref"));
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "formula1")
                    ctObj.formula1 = childNode.Value;
                else if (childNode.Name.LocalName == "formula2")
                    ctObj.formula2 = childNode.Value;
            }
            return ctObj;
        }
    ...
    public class CT_CustomProperty
    {
        ...
        public static CT_CustomProperty Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_CellWatch
    {
        ...
        public static CT_CellWatch Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_IgnoredErrors
    {
        ...
        public static CT_IgnoredErrors Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "extLst")
                    ctObj.extLst = CT_ExtensionList.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "ignoredError")
    ...
    public class CT_IgnoredError
    {
        ...
        public static CT_IgnoredError Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_IgnoredError ctObj = new CT_IgnoredError();
            ctObj.evalError = XmlHelper.ReadBool(node.Attribute("evalError"));
            ctObj.twoDigitTextYear = XmlHelper.ReadBool(node.Attribute("twoDigitTextYear"));
            ctObj.numberStoredAsText = XmlHelper.ReadBool(node.Attribute("numberStoredAsText"));
            ctObj.formula = XmlHelper.ReadBool(node.Attribute("formula"));
            ctObj.formulaRange = XmlHelper.ReadBool(node.Attribute("formulaRange"));
            ctObj.unlockedFormula = XmlHelper.ReadBool(node.Attribute("unlockedFormula"));
            ctObj.emptyCellReference = XmlHelper.ReadBool(node.Attribute("emptyCellReference"));
            ctObj.listDataValidation = XmlHelper.ReadBool(node.Attribute("listDataValidation"));
            ctObj.calculatedColumn = XmlHelper.ReadBool(node.Attribute("calculatedColumn"));
            ctObj.sqref = XmlHelper.ReadString(node.Attribute("sqref"));
            return ctObj;
        }
    ...
    public class CT_CellSmartTags
    {
        ...
        public static CT_CellSmartTags Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "cellSmartTag")
    ...
    public class CT_CellSmartTag
    {
        ...
        public static CT_CellSmartTag Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_CellSmartTag ctObj = new CT_CellSmartTag();
            ctObj.type = XmlHelper.ReadUInt(node.Attribute("type"));
            ctObj.deleted = XmlHelper.ReadBool(node.Attribute("deleted"));
            ctObj.xmlBased = XmlHelper.ReadBool(node.Attribute("xmlBased"));
            ctObj.cellSmartTagPr = new List<CT_CellSmartTagPr>();
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "cellSmartTagPr")
    ...
    public class CT_CellSmartTagPr
    {
        ...
        public static CT_CellSmartTagPr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_CellSmartTagPr ctObj = new CT_CellSmartTagPr();
            ctObj.key = XmlHelper.ReadString(node.Attribute("key"));
            ctObj.val = XmlHelper.ReadString(node.Attribute("val"));
            return ctObj;
        }
    ...
    public class CT_OleObject
    {
        ...
        public static CT_OleObject Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_OleObject ctObj = new CT_OleObject();
            ctObj.progId = XmlHelper.ReadString(node.Attribute("progId"));
            if (node.Attribute("dvAspect") != null)
                ctObj.dvAspect = (ST_DvAspect)Enum.Parse(typeof(ST_DvAspect), node.Attribute("dvAspect").Value);
            ctObj.link = XmlHelper.ReadString(node.Attribute("link"));
            if (node.Attribute("oleUpdate") != null)
                ctObj.oleUpdate = (ST_OleUpdate)Enum.Parse(typeof(ST_OleUpdate), node.Attribute("oleUpdate").Value);
            ctObj.autoLoad = XmlHelper.ReadBool(node.Attribute("autoLoad"));
            ctObj.shapeId = XmlHelper.ReadUInt(node.Attribute("shapeId"));
            ctObj.id = XmlHelper.ReadString(node.Attribute((XNamespace)PackageNamespaces.SCHEMA_RELATIONSHIPS + "id"));
            return ctObj;
        }
    ...
    public class CT_WebPublishItems
    {
        ...
        public static CT_WebPublishItems Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "webPublishItem")
    ...
    public class CT_WebPublishItem
    {
        ...
        public static CT_WebPublishItem Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            if (node.Attribute("sourceType") != null)
                ctObj.sourceType = (ST_WebSourceType)Enum.Parse(typeof(ST_WebSourceType), node.Attribute("sourceType").Value);
            ctObj.sourceRef = XmlHelper.ReadString(node.Attribute("sourceRef"));
            ...
            if (node.Attribute("autoRepublish") != null)
    ...
    public class CT_TableParts
    {
        ...
        public static CT_TableParts Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "tablePart")
    ...
    public class CT_TablePart
    {
        ...
        public static CT_TablePart Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Chartsheet
    {
        ...
        public static CT_Chartsheet Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_ChartsheetPr
    {
        ...
        public static CT_ChartsheetPr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_ChartsheetViews
    {
        ...
        public static CT_ChartsheetViews Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_ChartsheetView
    {
        ...
        public static CT_ChartsheetView Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            if (node.Attribute("zoomScale") != null)
                ctObj.zoomScale = XmlHelper.ReadUInt(node.Attribute("zoomScale"));
            if (node.Attribute("workbookViewId") != null)
                ctObj.workbookViewId = XmlHelper.ReadUInt(node.Attribute("workbookViewId"));
            if (node.Attribute("zoomToFit") != null)
                ctObj.zoomToFit = XmlHelper.ReadBool(node.Attribute("zoomToFit"));
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "extLst")
                    ctObj.extLst = CT_ExtensionList.Parse(childNode, namespaceManager);
    ...
    public class CT_ChartsheetProtection
    {
        ...
        public static CT_ChartsheetProtection Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_ChartsheetProtection ctObj = new CT_ChartsheetProtection();
            if (node.Attribute("password") != null)
                ctObj.password = XmlHelper.ReadBytes(node.Attribute("password"));
            if (node.Attribute("content") != null)
                ctObj.content = XmlHelper.ReadBool(node.Attribute("content"));
            if (node.Attribute("objects") != null)
                ctObj.objects = XmlHelper.ReadBool(node.Attribute("objects"));
            return ctObj;
        }
    ...
    public class CT_CustomChartsheetView
    {
        ...
        public static CT_CustomChartsheetView Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_CustomChartsheetView ctObj = new CT_CustomChartsheetView();
            ctObj.guid = XmlHelper.ReadString(node.Attribute("guid"));
            if (node.Attribute("scale") != null)
                ctObj.scale = XmlHelper.ReadUInt(node.Attribute("scale"));
            if (node.Attribute("state") != null)
                ctObj.state = (ST_SheetState)Enum.Parse(typeof(ST_SheetState), node.Attribute("state").Value);
            if (node.Attribute("zoomToFit") != null)
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "pageMargins")
                    ctObj.pageMargins = CT_PageMargins.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "pageSetup")
                    ctObj.pageSetup = CT_CsPageSetup.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "headerFooter")
    ...
    public class CT_CsPageSetup
    {
        ...
        public static CT_CsPageSetup Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_CsPageSetup ctObj = new CT_CsPageSetup();
            if (node.Attribute("paperSize") != null)
                ctObj.paperSize = XmlHelper.ReadUInt(node.Attribute("paperSize"));
            if (node.Attribute("firstPageNumber") != null)
                ctObj.firstPageNumber = XmlHelper.ReadUInt(node.Attribute("firstPageNumber"));
            if (node.Attribute("orientation") != null)
                ctObj.orientation = (ST_Orientation)Enum.Parse(typeof(ST_Orientation), node.Attribute("orientation").Value);
            if (node.Attribute("usePrinterDefaults") != null)
                ctObj.usePrinterDefaults = XmlHelper.ReadBool(node.Attribute("usePrinterDefaults"));
            if (node.Attribute("blackAndWhite") != null)
                ctObj.blackAndWhite = XmlHelper.ReadBool(node.Attribute("blackAndWhite"));
           
            if (node.Attribute("draft") != null)
                ctObj.draft = XmlHelper.ReadBool(node.Attribute("draft"));
            if (node.Attribute("useFirstPageNumber") != null)
                ctObj.useFirstPageNumber = XmlHelper.ReadBool(node.Attribute("useFirstPageNumber"));
            if (node.Attribute("horizontalDpi") != null)
                ctObj.horizontalDpi = XmlHelper.ReadUInt(node.Attribute("horizontalDpi"));
            if (node.Attribute("verticalDpi") != null)
                ctObj.verticalDpi = XmlHelper.ReadUInt(node.Attribute("verticalDpi"));
            if (node.Attribute("copies") != null)
                ctObj.copies = XmlHelper.ReadUInt(node.Attribute("copies"));
    ...
    public class CT_Drawing
    {
        ...
        public static CT_Drawing Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    {
        private string idField = string.Empty;
        public static CT_LegacyDrawing Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    {
        public static CT_CustomSheetViews Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "customSheetView")
    ...
    public class CT_Hyperlinks
    {
        ...
        public static CT_Hyperlinks Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "hyperlink")
    ...
    public class CT_ProtectedRanges
    {
        ...
        public static CT_ProtectedRanges Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "protectedRange")
    ...
    {
        public static CT_CellWatches Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "cellWatch")
    ...
    public class CT_CustomChartsheetViews
    {
        ...
        public static CT_CustomChartsheetViews Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_CustomProperties
    {
        ...
        public static CT_CustomProperties Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "customPr")
    ...
    {
        public static CT_OleObjects Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "oleObject")
    ...
    {
        public static CT_Controls Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
