...
namespace NPOI.OpenXmlFormats.Spreadsheet
{
    ...
    public class CT_FilterColumn
    {
        ...
        public static CT_FilterColumn Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_FilterColumn ctObj = new CT_FilterColumn();
            ctObj.colId = XmlHelper.ReadUInt(node.Attribute("colId"));
            ctObj.hiddenButton = XmlHelper.ReadBool(node.Attribute("hiddenButton"));
            ctObj.showButton = XmlHelper.ReadBool(node.Attribute("showButton"));
