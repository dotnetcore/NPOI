...
namespace Npoi.Core.OpenXmlFormats.Spreadsheet
{
	...
	public partial class CT_DdeLink
	{
		...
		internal static CT_DdeLink Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
	...
	public partial class CT_ExternalBook
	{
		...
		internal static CT_ExternalBook Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			if (node == null)
				return null;
			CT_ExternalBook ctObj = new CT_ExternalBook();

			ctObj.idField = XmlHelper.ReadString(node.Attribute((XNamespace)namespaceManager.LookupNamespace("r") + "id"));
			foreach (XElement childNode in node.ChildElements())
			{
				if (childNode.Name.LocalName == "sheetNames")
				...
				else if (childNode.Name.LocalName == "sheetDataSet")
	...
	public partial class CT_ExternalSheetName
	{
		...
		internal static CT_ExternalSheetName Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			CT_ExternalSheetName name = new CT_ExternalSheetName();
			name.val = XmlHelper.ReadString(node.Attribute("val"));
			return name;
		}
	...
	public partial class CT_ExternalDefinedName
	{
		...
		internal static CT_ExternalDefinedName Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			CT_ExternalDefinedName name = new CT_ExternalDefinedName();
			name.nameField = XmlHelper.ReadString(node.Attribute("name"));
			name.refersToField = XmlHelper.ReadString(node.Attribute("refersTo"));
			name.sheetIdFieldSpecified = node.Attribute("sheetId") != null;
			if (name.sheetIdFieldSpecified)
			{
				name.sheetIdField = XmlHelper.ReadUInt(node.Attribute("sheetId"));
			}
			return name;
		}
	...
	public partial class CT_OleLink
	{
		...
		internal static CT_OleLink Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
			throw new NotImplementedException();
		}
	...
	public partial class CT_ExternalSheetNames
	{
		...
		internal static CT_ExternalSheetNames Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
	...
	public partial class CT_ExternalDefinedNames
	{
		...
		internal static CT_ExternalDefinedNames Parse(XElement node, XmlNamespaceManager namespaceManager)
		{
