...
namespace Npoi.Core.OpenXmlFormats.Vml.Office
{
    ...
    public class CT_ShapeLayout
    {
        ...
        public static CT_ShapeLayout Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_IdMap
    {
        ...
        public static CT_IdMap Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            if (node.Attribute("v:ext") != null)
                ctObj.ext = (ST_Ext)Enum.Parse(typeof(ST_Ext), node.Attribute("v:ext").Value);
            ctObj.data = XmlHelper.ReadString(node.Attribute("data"));
            return ctObj;
        }
    ...
    {
        public static CT_RegroupTable Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "entry")
    ...
    public class CT_Entry
    {
        ...
        public static CT_Entry Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("new") != null)
                ctObj.@new = XmlHelper.ReadInt(node.Attribute("new"));
            if (node.Attribute("old") != null)
                ctObj.old = XmlHelper.ReadInt(node.Attribute("old"));
            return ctObj;
        }
    ...
    public class CT_Rules
    {
        ...
        public static CT_Rules Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_R
    {
        ...
        public static CT_R Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("type") != null)
                ctObj.type = (ST_RType)Enum.Parse(typeof(ST_RType), node.Attribute("type").Value);
            if (node.Attribute("how") != null)
                ctObj.how = (ST_How)Enum.Parse(typeof(ST_How), node.Attribute("how").Value);
            ctObj.idref = XmlHelper.ReadString(node.Attribute("idref"));
            ctObj.proxy = new List<CT_Proxy>();
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "proxy")
    ...
    public class CT_Proxy
    {
        ...
        public static CT_Proxy Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
