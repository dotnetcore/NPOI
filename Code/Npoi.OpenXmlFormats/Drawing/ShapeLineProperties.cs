...
namespace NPOI.OpenXmlFormats.Dml
{
    ...
    public class CT_LineEndProperties
    {
        ...
        public static CT_LineEndProperties Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_LineEndProperties ctObj = new CT_LineEndProperties();
            if (node.Attribute("type") != null)
                ctObj.type = (ST_LineEndType)Enum.Parse(typeof(ST_LineEndType), node.Attribute("type").Value);
            if (node.Attribute("w") != null)
                ctObj.w = (ST_LineEndWidth)Enum.Parse(typeof(ST_LineEndWidth), node.Attribute("w").Value);
            if (node.Attribute("len") != null)
                ctObj.len = (ST_LineEndLength)Enum.Parse(typeof(ST_LineEndLength), node.Attribute("len").Value);
            return ctObj;
        }
    ...
    {
        public static CT_LineJoinMiterProperties Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_LineJoinMiterProperties ctObj = new CT_LineJoinMiterProperties();
            ctObj.lim = XmlHelper.ReadInt(node.Attribute("lim"));
            return ctObj;
        }
    ...
    {
        public static CT_PresetLineDashProperties Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_PresetLineDashProperties ctObj = new CT_PresetLineDashProperties();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_PresetLineDashVal)Enum.Parse(typeof(ST_PresetLineDashVal), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    {
        public static CT_DashStop Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_DashStop ctObj = new CT_DashStop();
            ctObj.d = XmlHelper.ReadInt(node.Attribute("d"));
            ctObj.sp = XmlHelper.ReadInt(node.Attribute("sp"));
            return ctObj;
        }
    ...
    public class CT_LineProperties
    {
        ...
        public static CT_LineProperties Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_LineProperties ctObj = new CT_LineProperties();
            ctObj.w = XmlHelper.ReadInt(node.Attribute("w"));
            if (node.Attribute("cap") != null)
                ctObj.cap = (ST_LineCap)Enum.Parse(typeof(ST_LineCap), node.Attribute("cap").Value);
            if (node.Attribute("cmpd") != null)
                ctObj.cmpd = (ST_CompoundLine)Enum.Parse(typeof(ST_CompoundLine), node.Attribute("cmpd").Value);
            if (node.Attribute("algn") != null)
                ctObj.algn = (ST_PenAlignment)Enum.Parse(typeof(ST_PenAlignment), node.Attribute("algn").Value);
