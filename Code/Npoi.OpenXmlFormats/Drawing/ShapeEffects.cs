...
namespace NPOI.OpenXmlFormats.Dml
{
    ...
    public class CT_Blip
    {
        ...
        public static CT_Blip Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.embed = XmlHelper.ReadString(node.Attribute("r:embed"));
            ctObj.link = XmlHelper.ReadString(node.Attribute("r:link"));
            if (node.Attribute("cstate") != null)
                ctObj.cstate = (ST_BlipCompression)Enum.Parse(typeof(ST_BlipCompression), node.Attribute("cstate").Value);
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                //else if (childNode.Name.LocalName == "Items")
    ...
    {
        public static CT_SoftEdgesEffect Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_SoftEdgesEffect ctObj = new CT_SoftEdgesEffect();
            ctObj.rad = XmlHelper.ReadLong(node.Attribute("rad"));
            return ctObj;
        }
    ...
    public class CT_ReflectionEffect
    {
        ...
        public static CT_ReflectionEffect Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.blurRad = XmlHelper.ReadLong(node.Attribute("blurRad"));
            ctObj.stA = XmlHelper.ReadInt(node.Attribute("stA"));
            ctObj.stPos = XmlHelper.ReadInt(node.Attribute("stPos"));
            ctObj.endA = XmlHelper.ReadInt(node.Attribute("endA"));
            ctObj.endPos = XmlHelper.ReadInt(node.Attribute("endPos"));
            ctObj.dist = XmlHelper.ReadLong(node.Attribute("dist"));
            ctObj.dir = XmlHelper.ReadInt(node.Attribute("dir"));
            ctObj.fadeDir = XmlHelper.ReadInt(node.Attribute("fadeDir"));
            ctObj.sx = XmlHelper.ReadInt(node.Attribute("sx"));
            ctObj.sy = XmlHelper.ReadInt(node.Attribute("sy"));
            ctObj.kx = XmlHelper.ReadInt(node.Attribute("kx"));
            ctObj.ky = XmlHelper.ReadInt(node.Attribute("ky"));
    ...
    public class CT_PresetShadowEffect
    {
        ...
        public static CT_PresetShadowEffect Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("prst") != null)
                ctObj.prst = (ST_PresetShadowVal)Enum.Parse(typeof(ST_PresetShadowVal), node.Attribute("prst").Value);
            ctObj.dist = XmlHelper.ReadLong(node.Attribute("dist"));
            ctObj.dir = XmlHelper.ReadInt(node.Attribute("dir"));
            foreach (XElement childNode in node.ChildElements())
            {
    ...
    public class CT_FillOverlayEffect
    {
        ...
        public static CT_FillOverlayEffect Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("blend") != null)
                ctObj.blend = (ST_BlendMode)Enum.Parse(typeof(ST_BlendMode), node.Attribute("blend").Value);
            foreach (XElement childNode in node.ChildElements())
            {
    ...
    public class CT_GradientFillProperties
    {
        ...
        public static CT_GradientFillProperties Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("flip") != null)
                ctObj.flip = (ST_TileFlipMode)Enum.Parse(typeof(ST_TileFlipMode), node.Attribute("flip").Value);
            ctObj.rotWithShape = XmlHelper.ReadBool(node.Attribute("rotWithShape"));
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "gsLst")
                    ctObj.gsLst = CT_GradientStopList.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "lin")
                ...
                else if (childNode.Name.LocalName == "tileRect")
    ...
    public class CT_LinearShadeProperties
    {
        ...
        public static CT_LinearShadeProperties Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.ang = XmlHelper.ReadInt(node.Attribute("ang"));
    ...
    public class CT_PathShadeProperties
    {
        ...
        public static CT_PathShadeProperties Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("path") != null)
                ctObj.path = (ST_PathShadeType)Enum.Parse(typeof(ST_PathShadeType), node.Attribute("path").Value);
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "fillToRect")
    ...
    public class CT_TileInfoProperties
    {
        ...
        public static CT_TileInfoProperties Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_TileInfoProperties ctObj = new CT_TileInfoProperties();
            ctObj.tx = XmlHelper.ReadLong(node.Attribute("tx"));
            ctObj.ty = XmlHelper.ReadLong(node.Attribute("ty"));
            ctObj.sx = XmlHelper.ReadInt(node.Attribute("sx"));
            ctObj.sy = XmlHelper.ReadInt(node.Attribute("sy"));
            if (node.Attribute("flip") != null)
                ctObj.flip = (ST_TileFlipMode)Enum.Parse(typeof(ST_TileFlipMode), node.Attribute("flip").Value);
    ...
    {
        public static CT_StretchInfoProperties Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "fillRect")
    ...
    public class CT_PatternFillProperties
    {
        ...
        public static CT_PatternFillProperties Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("prst") != null)
                ctObj.prst = (ST_PresetPatternVal)Enum.Parse(typeof(ST_PresetPatternVal), node.Attribute("prst").Value);
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "fgClr")
                    ctObj.fgClr = CT_Color.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "bgClr")
    ...
    {
        public static CT_BlurEffect Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_BlurEffect ctObj = new CT_BlurEffect();
            ctObj.rad = XmlHelper.ReadLong(node.Attribute("rad"));
            ctObj.grow = XmlHelper.ReadBool(node.Attribute("grow"));
            return ctObj;
        }
    ...
    public class CT_EffectContainer
    {
        ...
        public static CT_EffectContainer Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("type") != null)
                ctObj.type = (ST_EffectContainerType)Enum.Parse(typeof(ST_EffectContainerType), node.Attribute("type").Value);
    ...
    {
        public static CT_GradientStopList Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "gs")
