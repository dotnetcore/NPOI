...
namespace NPOI.OpenXmlFormats.Wordprocessing
{
    ...
    public class CT_PermStart : CT_Perm
    {
        ...
        public static new CT_PermStart Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("w:edGrp") != null)
                ctObj.edGrp = (ST_EdGrp)Enum.Parse(typeof(ST_EdGrp), node.Attribute("w:edGrp").Value);
            ctObj.ed = XmlHelper.ReadString(node.Attribute("w:ed"));
