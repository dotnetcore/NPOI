...
namespace NPOI.OpenXmlFormats.Wordprocessing
{
    ...
    public class CT_Tbl
    {
        ...
        public static CT_Tbl Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            {
                if (childNode.Name.LocalName == "customXmlMoveToRangeEnd")
                {
                ...
                else if (childNode.Name.LocalName == "tr")
                {
    ...
    public class CT_TblGridChange : CT_Markup
    {
        ...
        public static new CT_TblGridChange Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "tblGrid")
    ...
    public class CT_TblGrid : CT_TblGridBase
    {
        ...
        public static CT_TblGrid Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "tblGridChange")
                    ctObj.tblGridChange = CT_TblGridChange.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "gridCol")
    ...
    {
        public static CT_TblOverlap Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_TblWidth
    {
        ...
        public static CT_TblWidth Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.w = XmlHelper.ReadString(node.Attribute("w:w"));
    ...
    {
        public static new CT_TblPrChange Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "tblPr")
    ...
    public class CT_TblPrBase
    {
        ...
        public static CT_TblPrBase Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "tblCellSpacing")
                    ctObj.tblCellSpacing = CT_TblWidth.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "tblInd")
                    ctObj.tblInd = CT_TblWidth.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "tblBorders")
    ...
    public class CT_TblPPr
    {
        ...
        public static CT_TblPPr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_TblPPr ctObj = new CT_TblPPr();
            ctObj.leftFromText = XmlHelper.ReadULong(node.Attribute("w:leftFromText"));
            ctObj.rightFromText = XmlHelper.ReadULong(node.Attribute("w:rightFromText"));
            ctObj.topFromText = XmlHelper.ReadULong(node.Attribute("w:topFromText"));
            ctObj.bottomFromText = XmlHelper.ReadULong(node.Attribute("w:bottomFromText"));
            if (node.Attribute("w:vertAnchor") != null)
                ctObj.vertAnchor = (ST_VAnchor)Enum.Parse(typeof(ST_VAnchor), node.Attribute("w:vertAnchor").Value);
            if (node.Attribute("w:horzAnchor") != null)
                ctObj.horzAnchor = (ST_HAnchor)Enum.Parse(typeof(ST_HAnchor), node.Attribute("w:horzAnchor").Value);
            if (node.Attribute("w:tblpXSpec") != null)
                ctObj.tblpXSpec = (ST_XAlign)Enum.Parse(typeof(ST_XAlign), node.Attribute("w:tblpXSpec").Value);
            ctObj.tblpX = XmlHelper.ReadString(node.Attribute("w:tblpX"));
            if (node.Attribute("w:tblpYSpec") != null)
                ctObj.tblpYSpec = (ST_YAlign)Enum.Parse(typeof(ST_YAlign), node.Attribute("w:tblpYSpec").Value);
    ...
    public class CT_Height
    {
        ...
        public static CT_Height Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.val = XmlHelper.ReadULong(node.Attribute("w:val"));
            if (node.Attribute("w:hRule") != null)
                ctObj.hRule = (ST_HeightRule)Enum.Parse(typeof(ST_HeightRule), node.Attribute("w:hRule").Value);
            return ctObj;
        }
    ...
    public class CT_TblPrExChange : CT_TrackChange
    {
        ...
        public static new CT_TblPrExChange Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "tblPrEx")
    ...
    public class CT_TblPrExBase
    {
        ...
        public static CT_TblPrExBase Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "tblW")
                    ctObj.tblW = CT_TblWidth.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "jc")
                    ctObj.jc = CT_Jc.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "tblCellSpacing")
    ...
    public class CT_TblPrEx : CT_TblPrExBase
    {
        ...
        public static new CT_TblPrEx Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "tblPrExChange")
    ...
    public class CT_TblBorders
    {
        ...
        public static CT_TblBorders Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "insideH")
                    ctObj.insideH = CT_Border.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "insideV")
    ...
    public class CT_TblPr : CT_TblPrBase
    {
        ...
        public static new CT_TblPr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "tblPrChange")
                    ctObj.tblPrChange = CT_TblPrChange.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "tblStyle")
                    ctObj.tblStyle = CT_String.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "tblpPr")
                    ctObj.tblpPr = CT_TblPPr.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "tblOverlap")
    ...
    public class CT_TrPrChange : CT_TrackChange
    {
        ...
        public static new CT_TrPrChange Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "trPr")
    ...
    public class CT_TrPrBase
    {
        ...
        public static CT_TrPrBase Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "tblHeader")
                {
                    ctObj.Items.Add(CT_OnOff.Parse(childNode, namespaceManager));
                ...
                else if (childNode.Name.LocalName == "wAfter")
                {
                    ctObj.Items.Add(CT_TblWidth.Parse(childNode, namespaceManager));
                    ctObj.ItemsElementName.Add(ItemsChoiceType2.wAfter);
                }
                else if (childNode.Name.LocalName == "wBefore")
                {
                    ctObj.Items.Add(CT_TblWidth.Parse(childNode, namespaceManager));
    ...
    public class CT_Tc
    {
        ...
        public static CT_Tc Parse(XElement node, XmlNamespaceManager namespaceManager, object parent)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "commentRangeEnd")
                {
                    ctObj.Items.Add(CT_MarkupRange.Parse(childNode, namespaceManager));
    ...
    public class CT_TrPr : CT_TrPrBase
    {
        ...
        public static new CT_TrPr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "trPrChange")
                    ctObj.trPrChange = CT_TrPrChange.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "gridBefore")
                {
                    ctObj.Items.Add(CT_DecimalNumber.Parse(childNode, namespaceManager));
                    ctObj.ItemsElementName.Add(ItemsChoiceType2.gridBefore);
                }
    ...
    {
        public static new CT_TcPrChange Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "tcPr")
    ...
    public class CT_TcPrInner : CT_TcPrBase
    {
        ...
        public static CT_TcPrInner Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "tcFitText")
                ...
                else if (childNode.Name.LocalName == "hideMark")
    ...
    public class CT_CellMergeTrackChange : CT_TrackChange
    {
        ...
        public static new CT_CellMergeTrackChange Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("w:vMerge") != null)
                ctObj.vMerge = (ST_AnnotationVMerge)Enum.Parse(typeof(ST_AnnotationVMerge), node.Attribute("w:vMerge").Value);
            if (node.Attribute("w:vMergeOrig") != null)
                ctObj.vMergeOrig = (ST_AnnotationVMerge)Enum.Parse(typeof(ST_AnnotationVMerge), node.Attribute("w:vMergeOrig").Value);
            ctObj.author = XmlHelper.ReadString(node.Attribute("w:author"));
            ctObj.date = XmlHelper.ReadString(node.Attribute("w:date"));
            ctObj.id = XmlHelper.ReadString(node.Attribute("r:id"));
            return ctObj;
        ...
        public static CT_TcBorders Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "top")
                    ...
                    ctObj.insideV = CT_Border.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "tl2br")
                    ctObj.tl2br = CT_Border.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "tr2bl")
    ...
    public class CT_TcPr : CT_TcPrInner
    {
        ...
        public static new CT_TcPr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "tcPrChange")
                    ctObj.tcPrChange = CT_TcPrChange.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "cellIns")
                    ctObj.cellIns = CT_TrackChange.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "cellDel")
                    ctObj.cellDel = CT_TrackChange.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "cellMerge")
    ...
    public class CT_Columns
    {
        ...
        public static CT_Columns Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("w:equalWidth") != null)
                ctObj.equalWidth = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:equalWidth").Value);
            ctObj.space = XmlHelper.ReadULong(node.Attribute("w:space"));
            ctObj.num = XmlHelper.ReadString(node.Attribute("w:num"));
            if (node.Attribute("w:sep") != null)
                ctObj.sep = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:sep").Value);
            ctObj.col = new List<CT_Column>();
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "col")
...
#region Table Row
    ...
    public class CT_Row
    {
        ...
        public static CT_Row Parse(XElement node, XmlNamespaceManager namespaceManager, object parent)
        {
            ...
            ctObj.rsidTr = XmlHelper.ReadBytes(node.Attribute("w:rsidTr"));
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "tc")
                {
