...
namespace NPOI.OpenXmlFormats.Wordprocessing
{
    ...
    public class CT_CustomXmlRow
    {
        ...
        public static CT_CustomXmlRow Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_CustomXmlRow ctObj = new CT_CustomXmlRow();
            ctObj.uri = XmlHelper.ReadString(node.Attribute("w:uri"));
            ctObj.element = XmlHelper.ReadString(node.Attribute("w:element"));

            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "customXmlMoveFromRangeStart")
                {
                ...
                else if (childNode.Name.LocalName == "customXmlPr")
                {
    ...
    public class CT_CustomXmlPr
    {
        ...
        public static CT_CustomXmlPr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "placeholder")
                    ctObj.placeholder = CT_String.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "attr")
    ...
    public class CT_Attr
    {
        ...
        public static CT_Attr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_CustomXmlRun
    {
        ...
        public static CT_CustomXmlRun Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_SmartTagRun
    {
        ...
        public static CT_SmartTagRun Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "customXmlMoveToRangeStart")
                {
                    ctObj.Items.Add(CT_TrackChange.Parse(childNode, namespaceManager));
    ...
    public class CT_CustomXmlBlock
    {
        ...
        public static CT_CustomXmlBlock Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "del")
                {
                    ctObj.Items.Add(CT_RunTrackChange.Parse(childNode, namespaceManager));
