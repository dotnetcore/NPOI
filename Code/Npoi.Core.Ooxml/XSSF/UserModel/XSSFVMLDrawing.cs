		...
		internal void Write(Stream out1)
		{
			using (StreamWriter sw = new StreamWriter(out1))
			{
				...
				for (int i = 0; i < _items.Count; i++)
				{
					...
					if (xc is XNode)
					{
						sw.Write(((XNode)xc).OuterXml().Replace(" xmlns:v=\"urn:schemas-microsoft-com:vml\"", "").Replace(" xmlns:x=\"urn:schemas-microsoft-com:office:excel\"", "").Replace(" xmlns:o=\"urn:schemas-microsoft-com:office:office\"", "").Replace("&#xD;&#xA;", ""));
					}
