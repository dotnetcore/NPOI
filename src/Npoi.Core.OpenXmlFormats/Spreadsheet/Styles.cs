...
namespace Npoi.Core.OpenXmlFormats.Spreadsheet
{
    ...
    public class CT_FontScheme
    {
        ...
        public static CT_FontScheme Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_FontScheme ctObj = new CT_FontScheme();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_FontScheme)Enum.Parse(typeof(ST_FontScheme), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_FontName
    {
        ...
        public static CT_FontName Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.val = XmlHelper.ReadString(node.Attribute("val"));
            return ctObj;
        }
    ...
    public class CT_FontSize
    {
        ...
        public static CT_FontSize Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.val = XmlHelper.ReadDouble(node.Attribute("val"));
            return ctObj;
        }
    ...
    public class CT_UnderlineProperty
    {
        ...
        public static CT_UnderlineProperty Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_UnderlineProperty ctObj = new CT_UnderlineProperty();
            if (node.Attribute("val") != null)
                ctObj.val = (ST_UnderlineValues)Enum.Parse(typeof(ST_UnderlineValues), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_VerticalAlignFontProperty
    {
        ...
        public static CT_VerticalAlignFontProperty Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("val") != null)
                ctObj.val = (ST_VerticalAlignRun)Enum.Parse(typeof(ST_VerticalAlignRun), node.Attribute("val").Value);
            return ctObj;
        }
    ...
    public class CT_IntProperty
    {
        ...
        public static CT_IntProperty Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
