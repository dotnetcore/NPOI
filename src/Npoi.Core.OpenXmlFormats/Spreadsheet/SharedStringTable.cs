...
namespace Npoi.Core.OpenXmlFormats.Spreadsheet
{
    ...
    public class CT_PhoneticRun
    {
        ...
        public static CT_PhoneticRun Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_PhoneticRun ctObj = new CT_PhoneticRun();
            ctObj.sb = XmlHelper.ReadUInt(node.Attribute("sb"));
            ctObj.eb = XmlHelper.ReadUInt(node.Attribute("eb"));

            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "t")
                    ctObj.t = childNode.Value;
            }
            return ctObj;
        }
    ...
    public class CT_PhoneticPr
    {
        ...
        public static CT_PhoneticPr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            if (node.Attribute("type") != null)
                ctObj.type = (ST_PhoneticType)Enum.Parse(typeof(ST_PhoneticType), node.Attribute("type").Value);
            if (node.Attribute("alignment") != null)
                ctObj.alignment = (ST_PhoneticAlignment)Enum.Parse(typeof(ST_PhoneticAlignment), node.Attribute("alignment").Value);
            return ctObj;
        }
