...
namespace Npoi.Core.OpenXmlFormats.Wordprocessing
{
    ...
    public class CT_SdtBlock
    {
        ...
        public static CT_SdtBlock Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_SdtRun
    {
        ...
        public static CT_SdtRun Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_SdtCell
    {
        ...
        public static CT_SdtCell Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    {
        public static CT_SdtComboBox Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_SdtComboBox ctObj = new CT_SdtComboBox();
            ctObj.lastValue = XmlHelper.ReadString(node.Attribute("w:lastValue"));
            ctObj.listItem = new List<CT_SdtListItem>();
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "listItem")
    ...
    public class CT_SdtDocPart
    {
        ...
        public static CT_SdtDocPart Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "docPartGallery")
                    ctObj.docPartGallery = CT_String.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "docPartCategory")
                    ctObj.docPartCategory = CT_String.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "docPartUnique")
    ...
    public class CT_SdtDropDownList
    {
        ...
        public static CT_SdtDropDownList Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_SdtContentBlock
    {
        ...
        public static CT_SdtContentBlock Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "bookmarkStart")
                {
                    ctObj.Items.Add(CT_Bookmark.Parse(childNode, namespaceManager));
    ...
    public class CT_SdtPr
    {
        ...
        public static CT_SdtPr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "equation")
                {
                    ctObj.Items.Add(new CT_Empty());
                    ctObj.ItemsElementName.Add(SdtPrElementType.equation);
                }
                else if (childNode.Name.LocalName == "group")
                {
                    ctObj.Items.Add(new CT_Empty());
                    ctObj.ItemsElementName.Add(SdtPrElementType.group);
                }
                else if (childNode.Name.LocalName == "id")
                {
    ...
    public class CT_SdtListItem
    {
        ...
        public static CT_SdtListItem Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_SdtListItem ctObj = new CT_SdtListItem();
            ctObj.displayText = XmlHelper.ReadString(node.Attribute("w:displayText"));
            ctObj.value = XmlHelper.ReadString(node.Attribute("w:value"));
            return ctObj;
        }
    ...
    public class CT_SdtDateMappingType
    {
        ...
        public static CT_SdtDateMappingType Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_SdtDateMappingType ctObj = new CT_SdtDateMappingType();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_SdtDateMappingType)Enum.Parse(typeof(ST_SdtDateMappingType), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_CalendarType
    {
        ...
        public static CT_CalendarType Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_CalendarType ctObj = new CT_CalendarType();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_CalendarType)Enum.Parse(typeof(ST_CalendarType), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_SdtDate
    {
        ...
        public static CT_SdtDate Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_SdtDate ctObj = new CT_SdtDate();
            ctObj.fullDateField = XmlHelper.ReadString(node.Attribute("w.fullDate"));
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "dateFormat")
                ...
                else if (childNode.Name.LocalName == "storeMappedDataAs")
                    ctObj.storeMappedDataAs = CT_SdtDateMappingType.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "calendar")
    ...
    public class CT_SdtRow
    {
        ...
        public static CT_SdtRow Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_SdtText
    {
        ...
        public static CT_SdtText Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_SdtText ctObj = new CT_SdtText();
            if (node.Attribute("w:multiLine") != null)
                ctObj.multiLine = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:multiLine").Value);
            return ctObj;
        }
    ...
    {
        public static CT_Lock Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Lock ctObj = new CT_Lock();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_Lock)Enum.Parse(typeof(ST_Lock), node.Attribute("w:val").Value);
            return ctObj;
        }
