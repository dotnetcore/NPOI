...
namespace Npoi.Core.OpenXmlFormats.Wordprocessing
{
    ...
    public class CT_Num
    {
        ...
        public static CT_Num Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.numId = XmlHelper.ReadString(node.Attribute("w:numId"));
            ctObj.lvlOverride = new List<CT_NumLvl>();
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "abstractNumId")
                    ctObj.abstractNumId = CT_DecimalNumber.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "lvlOverride")
    ...
    public class CT_NumLvl
    {
        ...
        public static CT_NumLvl Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.ilvl = XmlHelper.ReadString(node.Attribute("w:ilvl"));
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "startOverride")
                    ctObj.startOverride = CT_DecimalNumber.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "lvl")
    ...
    public class CT_NumPicBullet
    {
        ...
        public static CT_NumPicBullet Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.numPicBulletId = XmlHelper.ReadString(node.Attribute("w:numPicBulletId"));
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "pict")
    ...
    public class CT_NumFmt
    {
        public static CT_NumFmt Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_NumberFormat)Enum.Parse(typeof(ST_NumberFormat), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    {
        public static CT_NumRestart Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Sym
    {
        ...
        public static CT_Sym Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.font = XmlHelper.ReadString(node.Attribute("w:font"));
    ...
    public class CT_AbstractNum
    {
        ...
        public static CT_AbstractNum Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_AbstractNum ctObj = new CT_AbstractNum();
            ctObj.abstractNumId = XmlHelper.ReadString(node.Attribute("w:abstractNumId"));
            ctObj.lvl = new List<CT_Lvl>();
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "nsid")
                    ctObj.nsid = CT_LongHexNumber.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "multiLevelType")
                    ctObj.multiLevelType = CT_MultiLevelType.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "tmpl")
                ...
                else if (childNode.Name.LocalName == "styleLink")
                    ctObj.styleLink = CT_String.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "numStyleLink")
    ...
    {
        public static CT_MultiLevelType Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Lvl
    {
        ...
        public static CT_Lvl Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.ilvl = XmlHelper.ReadString(node.Attribute("w:ilvl"));
            ctObj.tplc = XmlHelper.ReadBytes(node.Attribute("w:tplc"));
            if (node.Attribute("w:tentative") != null)
                ctObj.tentative = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:tentative").Value);
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "start")
                ...
                else if (childNode.Name.LocalName == "lvlRestart")
    ...
    {
        public static CT_LevelSuffix Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_LvlLegacy
    {
        ...
        public static CT_LvlLegacy Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_LvlLegacy ctObj = new CT_LvlLegacy();
            if (node.Attribute("w:legacy") != null)
                ctObj.legacy = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:legacy").Value);
            ctObj.legacySpace = XmlHelper.ReadULong(node.Attribute("w:legacySpace"));
            ctObj.legacyIndent = XmlHelper.ReadString(node.Attribute("w:legacyIndent"));
            return ctObj;
        }
    ...
    public class CT_LsdException
    {
        ...
        public static CT_LsdException Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_LsdException ctObj = new CT_LsdException();
            ctObj.name = XmlHelper.ReadString(node.Attribute("w:name"));
            if (node.Attribute("w:locked") != null)
                ctObj.locked = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:locked").Value);
            ctObj.uiPriority = XmlHelper.ReadString(node.Attribute("w:uiPriority"));
            if (node.Attribute("w:semiHidden") != null)
                ctObj.semiHidden = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:semiHidden").Value);
            if (node.Attribute("w:unhideWhenUsed") != null)
                ctObj.unhideWhenUsed = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:unhideWhenUsed").Value);
            if (node.Attribute("w:qFormat") != null)
                ctObj.qFormat = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:qFormat").Value);
            return ctObj;
        }
    ...
    {
        public static new CT_TrackChangeNumbering Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_TrackChangeNumbering ctObj = new CT_TrackChangeNumbering();
            ctObj.original = XmlHelper.ReadString(node.Attribute("original"));
