...
namespace Npoi.Core.OpenXmlFormats.Wordprocessing
{
    ...
    public class CT_FFName
    {
        ...
        public static CT_FFName Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_FldChar
    {
        ...
        public static CT_FldChar Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("w:fldCharType") != null)
                ctObj.fldCharType = (ST_FldCharType)Enum.Parse(typeof(ST_FldCharType), node.Attribute("w:fldCharType").Value);
            if (node.Attribute("w:fldLock") != null)
                ctObj.fldLock = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:fldLock").Value);
            if (node.Attribute("w:dirty") != null)
                ctObj.dirty = (ST_OnOff)Enum.Parse(typeof(ST_OnOff), node.Attribute("w:dirty").Value);
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "ffData")
                {
                    ctObj.ffDataField = CT_FFData.Parse(childNode, namespaceManager);
                }
                else if (childNode.Name.LocalName == "fldData")
                {
    ...
    public class CT_FFHelpText
    {
        ...
        public static CT_FFHelpText Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            if (node.Attribute("w:type") != null)
            {
                ...
                ctObj.typeField = (ST_InfoTextType)Enum.Parse(typeof(ST_InfoTextType), node.Attribute("w:type").Value);
            }
            ctObj.valField = XmlHelper.ReadString(node.Attribute("w:val"));
            return ctObj;
        }
    ...
    public class CT_FFStatusText
    {
        ...
        public static CT_FFStatusText Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
