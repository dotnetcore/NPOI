...
namespace Npoi.Core.OpenXmlFormats.Wordprocessing
{
    ...
    public class CT_R
    {
        ...
        public static CT_R Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_R ctObj = new CT_R();
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "endnoteRef")
                {
                    ctObj.Items.Add(new CT_Empty());
                    ctObj.ItemsElementName.Add(RunItemsChoiceType.endnoteRef);
                }
                else if (childNode.Name.LocalName == "endnoteReference")
                {
                ...
                else if (childNode.Name.LocalName == "tab")
                {
                    ctObj.Items.Add(new CT_Empty());
                    ctObj.ItemsElementName.Add(RunItemsChoiceType.tab);
                }
                else if (childNode.Name.LocalName == "yearShort")
                {
                    ctObj.Items.Add(new CT_Empty());
    ...
    public class CT_RubyAlign
    {
        ...
        public static CT_RubyAlign Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_RubyAlign ctObj = new CT_RubyAlign();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_RubyAlign)Enum.Parse(typeof(ST_RubyAlign), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_RubyPr
    {
        ...
        public static CT_RubyPr Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "dirty")
    ...
    public class CT_RubyContent
    {
        ...
        public static CT_RubyContent Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "oMath")
                {
    ...
    public class CT_Ruby
    {
        ...
        public static CT_Ruby Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
    ...
    public class CT_Jc
    {
        public static CT_Jc Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_Jc ctObj = new CT_Jc();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_Jc)Enum.Parse(typeof(ST_Jc), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    {
        public static CT_TextDirection Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_TextDirection ctObj = new CT_TextDirection();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_TextDirection)Enum.Parse(typeof(ST_TextDirection), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    {
        public static CT_TextAlignment Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_TextAlignment ctObj = new CT_TextAlignment();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_TextAlignment)Enum.Parse(typeof(ST_TextAlignment), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    {
        public static CT_TextboxTightWrap Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_TextboxTightWrap ctObj = new CT_TextboxTightWrap();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_TextboxTightWrap)Enum.Parse(typeof(ST_TextboxTightWrap), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    {
        public static CT_VerticalAlignRun Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_VerticalAlignRun ctObj = new CT_VerticalAlignRun();
            if (node.Attribute("w:val") != null)
                ctObj.val = (ST_VerticalAlignRun)Enum.Parse(typeof(ST_VerticalAlignRun), node.Attribute("w:val").Value);
            return ctObj;
        }
    ...
    public class CT_RunTrackChange : CT_TrackChange
    {
        ...
        public new static CT_RunTrackChange Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "acc")
                {
                ...
                else if (childNode.Name.LocalName == "nary")
                {
                ...
                else if (childNode.Name.LocalName == "phant")
                {
                ...
                else if (childNode.Name.LocalName == "limUpp")
                {
