...
namespace Npoi.Core.OpenXmlFormats.Wordprocessing
{
    ...
    public class CT_PageSz
    {
        ...
        public static CT_PageSz Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("w:orient") != null)
                ctObj.orient = (ST_PageOrientation)Enum.Parse(typeof(ST_PageOrientation), node.Attribute("w:orient").Value);
            ctObj.code = XmlHelper.ReadString(node.Attribute("w:code"));
            return ctObj;
        }
    ...
    public class CT_PageMar
    {
        ...
        public static CT_PageMar Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            CT_PageMar ctObj = new CT_PageMar();
            ctObj.top = XmlHelper.ReadString(node.Attribute("w:top"));
            ctObj.right = XmlHelper.ReadULong(node.Attribute("w:right"));
            ctObj.bottom = XmlHelper.ReadString(node.Attribute("w:bottom"));
            ctObj.left = XmlHelper.ReadULong(node.Attribute("w:left"));
            ctObj.header = XmlHelper.ReadULong(node.Attribute("w:header"));
            ctObj.footer = XmlHelper.ReadULong(node.Attribute("w:footer"));
    ...
    public class CT_PaperSource
    {
        ...
        public static CT_PaperSource Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.first = XmlHelper.ReadString(node.Attribute("w:first"));
    ...
    public class CT_PageBorders
    {
        ...
        public static CT_PageBorders Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("w:zOrder") != null)
                ctObj.zOrder = (ST_PageBorderZOrder)Enum.Parse(typeof(ST_PageBorderZOrder), node.Attribute("w:zOrder").Value);
            if (node.Attribute("w:display") != null)
                ctObj.display = (ST_PageBorderDisplay)Enum.Parse(typeof(ST_PageBorderDisplay), node.Attribute("w:display").Value);
            if (node.Attribute("w:offsetFrom") != null)
                ctObj.offsetFrom = (ST_PageBorderOffset)Enum.Parse(typeof(ST_PageBorderOffset), node.Attribute("w:offsetFrom").Value);
    ...
    public class CT_PageNumber
    {
        ...
        public static CT_PageNumber Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            if (node.Attribute("w:fmt") != null)
                ctObj.fmt = (ST_NumberFormat)Enum.Parse(typeof(ST_NumberFormat), node.Attribute("w:fmt").Value);
            ctObj.start = XmlHelper.ReadString(node.Attribute("w:start"));
            ctObj.chapStyle = XmlHelper.ReadString(node.Attribute("w:chapStyle"));
            if (node.Attribute("w:chapSep") != null)
    ...
    public class CT_LineNumber
    {
        ...
        public static CT_LineNumber Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            ctObj.countBy = XmlHelper.ReadString(node.Attribute("w:countBy"));
            ctObj.start = XmlHelper.ReadString(node.Attribute("w:start"));
            ctObj.distance = XmlHelper.ReadULong(node.Attribute("w:distance"));
            if (node.Attribute("w:restart") != null)
