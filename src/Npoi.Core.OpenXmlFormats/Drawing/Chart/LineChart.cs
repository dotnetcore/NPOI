...
namespace Npoi.Core.OpenXmlFormats.Dml.Chart
{
    ...
    public class CT_LineSer
    {
        ...
        public static CT_LineSer Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            if (node == null)
                return null;
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                ...
                else if (childNode.Name.LocalName == "smooth")
    ...
    public class CT_Line3DChart
    {
        ...
        public static CT_Line3DChart Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "grouping")
                    ...
                    ctObj.dLbls = CT_DLbls.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "dropLines")
    ...
    public class CT_StockChart
    {
        ...
        public static CT_StockChart Parse(XElement node, XmlNamespaceManager namespaceManager)
        {
            ...
            foreach (XElement childNode in node.ChildElements())
            {
                if (childNode.Name.LocalName == "dLbls")
                    ctObj.dLbls = CT_DLbls.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "dropLines")
                    ctObj.dropLines = CT_ChartLines.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "hiLowLines")
                    ctObj.hiLowLines = CT_ChartLines.Parse(childNode, namespaceManager);
                else if (childNode.Name.LocalName == "upDownBars")
